...
<!-- ══ SECCIÓN: HISTORIAL ══ -->
<section class="admin-section d-none" id="sec-historial">
<div class="sec-header">
<h2><img alt="historial" height="20" src="/Clinica/img/emojis/historial.png" style="vertical-align:middle;" width="20"/> Historial de Citas</h2>
<span class="badge-total" id="historial-total">0 citas</span>
</div>
<!-- Filtros -->
<div class="filtros-historial mb-4">
<input class="form-control" id="filtro-paciente" placeholder="👤 Paciente (nombre)" type="text"/>
<input class="form-control" id="filtro-medico" placeholder="🩺 Médico (nombre)" type="text"/>
<input class="form-control" id="filtro-fecha" type="date"/>
<button class="btn-primary-admin" onclick="buscarHistorial()"><img alt="buscar" height="20" src="/Clinica/img/emojis/buscar.png" style="vertical-align:middle;" width="20"/> Buscar</button>
<button class="btn-secondary-admin" onclick="limpiarFiltros()"><img alt="cerrar" height="20" src="/Clinica/img/emojis/error.png" style="vertical-align:middle;" width="20"/> Limpiar</button>
</div>
<div class="table-wrap">
<table class="admin-table">
<thead>
<tr>
<th>Paciente</th><th>DNI</th><th>Médico</th>
<th>Especialidad</th><th>Fecha</th><th>Hora</th>
<th>Estado</th><th>Motivo</th>
</tr>
</thead>
<tbody id="tbody-historial">
<tr><td class="text-center text-muted py-3" colspan="8">Usa los filtros para buscar citas.</td></tr>
</tbody>
</table>
</div>
</section>
<!-- ══ SECCIÓN: CUENTA ══ -->
<section class="admin-section d-none" id="sec-cuenta">
<div class="sec-header">
<h2><img alt="contraseña" height="20" src="/Clinica/img/emojis/contrasena.png" style="vertical-align:middle;" width="20"/> Cambiar Contraseña</h2>
</div>
<div class="card-form">
<div class="alert alert-success d-none py-2" id="cuenta-exito"></div>
<div class="alert alert-danger d-none py-2" id="cuenta-error"></div>
<div class="mb-3">
<label class="form-label fw-semibold">Contraseña actual</label>
<input class="form-control" id="cuenta-actual" placeholder="••••••••" type="password"/>
</div>
<div class="mb-3">
<label class="form-label fw-semibold">Nueva contraseña</label>
<input class="form-control" id="cuenta-nueva" placeholder="••••••••" type="password"/>
</div>
<div class="mb-4">
<label class="form-label fw-semibold">Confirmar nueva contraseña</label>
<input class="form-control" id="cuenta-confirmar" placeholder="••••••••" type="password"/>
</div>
<button class="btn-primary-admin" onclick="cambiarPasswordAdmin()"><img alt="guardar" height="20" src="/Clinica/img/emojis/guardar.png" style="vertical-align:middle;" width="20"/> Actualizar contraseña</button>
</div>
</section>
</main>
</div>
<!-- MODAL: MÉDICO -->
<div aria-hidden="true" class="modal fade" id="modalMedico" tabindex="-1">
<div class="modal-dialog modal-dialog-centered">
<div class="modal-content">
<div class="modal-header text-white" style="background-color: #0E588E;">
<h5 class="modal-title" id="modal-medico-titulo">Nuevo Médico</h5>
<button class="btn-close btn-close-white" data-bs-dismiss="modal" type="button"></button>
</div>
<div class="modal-body">
<input id="medico-id" type="hidden"/>
<div class="alert alert-danger d-none py-2 small" id="medico-error"></div>
<div class="mb-3">
<label class="form-label fw-semibold">Nombre completo</label>
<input class="form-control" id="medico-nombre" placeholder="Méd. Apellido" type="text"/>
</div>
<div class="mb-3">
<label class="form-label fw-semibold">Correo</label>
<input class="form-control" id="medico-correo" placeholder="medico@clinica.com" type="email"/>
</div>
<div class="mb-3">
...
<div class="mb-3">
<label class="form-label fw-semibold" id="label-pass-medico">Contraseña</label>
<input class="form-control" id="medico-password" placeholder="••••••••" type="password"/>
<small class="text-muted d-none" id="hint-pass-medico">Dejar en blanco para no cambiarla</small>
</div>
</div>
<div class="modal-footer">
<button class="btn btn-secondary" data-bs-dismiss="modal" type="button">Cancelar</button>
<button class="btn text-white fw-semibold" onclick="guardarMedico()" style="background-color:#0E588E;" type="button">
<img alt="guardar" height="20" src="/Clinica/img/emojis/guardar.png" style="vertical-align:middle;" width="20"/> Guardar
                </button>
</div>
</div>
</div>
...
<!-- MODAL: ESPECIALIDAD -->
<div aria-hidden="true" class="modal fade" id="modalEspecialidad" tabindex="-1">
<div class="modal-dialog modal-dialog-centered">
<div class="modal-content">
<div class="modal-header text-white" style="background-color: #0E588E;">
<h5 class="modal-title" id="modal-esp-titulo">Nueva Especialidad</h5>
<button class="btn-close btn-close-white" data-bs-dismiss="modal" type="button"></button>
</div>
<div class="modal-body">
<input id="esp-id" type="hidden"/>
<div class="alert alert-danger d-none py-2 small" id="esp-error"></div>
<div class="mb-3">
<label class="form-label fw-semibold">Nombre de la especialidad</label>
<input class="form-control" id="esp-nombre" placeholder="Ej: Neurología" type="text"/>
</div>
<div class="mb-3">
<label class="form-label fw-semibold">Descripción (opcional)</label>
<textarea class="form-control" id="esp-descripcion" placeholder="Descripción breve..." rows="3"></textarea>
</div>
<div class="mb-3 form-check">
<input checked="" class="form-check-input" id="esp-activa" type="checkbox"/>
<label class="form-check-label fw-semibold" for="esp-activa">Especialidad activa</label>
</div>
</div>
<div class="modal-footer">
<button class="btn btn-secondary" data-bs-dismiss="modal" type="button">Cancelar</button>
<button class="btn text-white fw-semibold" onclick="guardarEspecialidad()" style="background-color:#0E588E;" type="button">
<img alt="guardar" height="20" src="/Clinica/img/emojis/guardar.png" style="vertical-align:middle;" width="20"/> Guardar
                </button>
</div>
</div>
...
<div aria-hidden="true" class="modal fade" id="modalConfirmar" tabindex="-1">
<div class="modal-dialog modal-dialog-centered modal-sm">
<div class="modal-content">
<div class="modal-header bg-danger text-white">
<h5 class="modal-title"><img alt="advertencia" height="20" src="/Clinica/img/emojis/advertencia.png" style="vertical-align:middle;" width="20"/>️ Confirmar eliminación</h5>
<button class="btn-close btn-close-white" data-bs-dismiss="modal" type="button"></button>
</div>
<div class="modal-body">
<p class="mb-0" id="confirmar-mensaje"></p>
</div>
<div class="modal-footer">
<button class="btn btn-secondary btn-sm" data-bs-dismiss="modal" type="button">Cancelar</button>
<button class="btn btn-danger btn-sm" id="confirmar-btn" type="button">Eliminar</button>
</div>
</div>
</div>
</div>

`;function ar(){return(0,j.jsx)(tr,{html:ir,scripts:[`/Clinica/js/admin.js`],title:`Panel Admin — Clínica José Pardo`})}var or=`
<!-- FRANJA SUPERIOR -->
<div class="franja-contacto d-none d-md-block">
<div class="container-fluid px-4 d-flex justify-content-between align-items-center">
<div class="d-flex gap-4">
<span><img alt="teléfono" height="20" src="/Clinica/img/emojis/telefono.png" style="vertical-align:middle;" width="20"/> Central: (01) 111-2222</span>
<span><img alt="reloj" height="20" src="/Clinica/img/emojis/reloj-alarma.png" style="vertical-align:middle;" width="20"/> Lun-Sáb: 7:00 am - 8:00 pm</span>
<span><img alt="ubicación" height="20" src="/Clinica/img/emojis/ubicacion.png" style="vertical-align:middle;" width="20"/> Av. José Pardo 452, Comas</span>
</div>
<div class="d-flex gap-3">
<a class="text-white text-decoration-none" href="#" style="font-size:0.85rem;"><img alt="email" height="20" src="/Clinica/img/emojis/email.png" style="vertical-align:middle;" width="20"/> atencion@clinicajosepardo.com.pe</a>
</div>
</div>
</div>
<!-- NAVBAR -->
<nav class="navbar navbar-expand-lg navbar-dark sticky-top" style="background-color:#0E588E; box-shadow:0 2px 12px rgba(0,0,0,0.15);">
<div class="container-fluid">
<a class="navbar-brand d-flex align-items-center gap-2" href="/Clinica/pages/index.html">
<img alt="Logo" class="rounded" height="40" src="/Clinica/img/3063176.png"/>
<span class="fw-bold">José Pardo</span>
</a>
...
<li class="nav-item"><a class="nav-link" href="/Clinica/pages/index.html"><img alt="inicio" height="20" src="/Clinica/img/emojis/rayo.png" style="vertical-align:middle;" width="20"/> Inicio</a></li>
<li class="nav-item"><a class="nav-link" href="https://www.instagram.com/_joseph_otto_.py/"><img alt="bot" height="20" src="/Clinica/img/emojis/bot.png" style="vertical-align:middle;" width="20"/> Redes</a></li>
<li class="nav-item dropdown">
<a aria-expanded="false" class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" id="navbarDropdown" role="button"><img alt="opciones" height="20" src="/Clinica/img/emojis/pendiente.png" style="vertical-align:middle;" width="20"/> Opciones</a>
<ul aria-labelledby="navbarDropdown" class="dropdown-menu">
<li><a class="dropdown-item" href="/Clinica/pages/nosotros.html"><img alt="persona" height="20" src="/Clinica/img/emojis/nosotros.png" style="vertical-align:middle;" width="20"/>‍<img alt="nosotros" height="20" src="/Clinica/img/emojis/nosotros.png" style="vertical-align:middle;" width="20"/> Nosotros</a></li>
<li><a class="dropdown-item" href="/Clinica/pages/nuestros-doctores.html"><img alt="doctor" height="20" src="/Clinica/img/emojis/doctor-avatar.png" style="vertical-align:middle;" width="20"/> Nuestros Doctores</a></li>
<li><a aria-current="page" class="dropdown-item active" href="/Clinica/pages/consejos-de-salud.html"><img alt="idea" height="20" src="/Clinica/img/emojis/idea.png" style="vertical-align:middle;" width="20"/> Consejos de Salud</a></li>
</ul>
</li>
</ul>
<div class="d-flex align-items-center gap-2 flex-wrap">
<button class="btn fw-semibold text-white" onclick="verificarSesionParaCita()" style="background-color: #1a6fa8; border-color: #0A3760; border-radius:20px;" type="button">
<img alt="calendario" height="20" src="/Clinica/img/emojis/calendario.png" style="vertical-align:middle;" width="20"/> Generar Cita
                </button>
<!-- CAMPANA -->
<div class="position-relative d-none" id="notif-campana-wrapper" style="margin-right:4px;">
<button id="notif-btn" onclick="toggleBandeja()" style="background:rgba(255,255,255,0.15); border:1.5px solid rgba(255,255,255,0.35);
                        border-radius:50%; width:40px; height:40px; cursor:pointer;
                        display:flex; align-items:center; justify-content:center;
                        position:relative; transition:background 0.2s;" title="Notificaciones">
<svg fill="none" height="20" stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewbox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg">
...
<span id="notif-badge" style="position:absolute; top:-4px; right:-4px;
                            ...
                            border:2px solid #0E588E; line-height:1;">0
                        </span>
</button>
<div id="notif-bandeja" style="display:none; position:absolute; right:0; top:48px;
                        width:320px; background:#fff; border-radius:14px;
                        box-shadow:0 8px 32px rgba(14,88,142,0.18);
                        border:1px solid #e3eef7; z-index:9999; overflow:hidden;">
<div style="background:#0E588E; color:#fff; padding:12px 16px;
                            display:flex; align-items:center; justify-content:space-between;">
<span style="font-weight:700; font-size:0.92rem;">🔔 Mis Notificaciones</span>
<span id="notif-count-label" style="background:rgba(255,255,255,0.2); border-radius:20px;
                                padding:2px 10px; font-size:0.75rem;"></span>
</div>
<div id="notif-lista" style="max-height:320px; overflow-y:auto; padding:10px 12px;">
<p class="text-muted text-center small py-3">Cargando...</p>
</div>
<div style="border-top:1px solid #e3eef7; padding:10px 16px; text-align:center;">
<a href="/Clinica/pages/mis-citas.html" style="color:#0E588E; font-size:0.82rem; font-weight:600; text-decoration:none;">
                        Ver todas mis citas →
                            </a>
</div>
</div>
...
<!-- FIN CAMPANA -->
<a class="btn btn-outline-light fw-semibold d-none" href="/Clinica/pages/login.html" id="btn-login" style="border-radius:20px;">
<img alt="acceso seguro" height="20" src="/Clinica/img/emojis/acceso-seguro.png" style="vertical-align:middle;" width="20"/> Iniciar Sesión
                </a>
<a class="btn btn-outline-light fw-semibold d-none" href="/Clinica/pages/mis-citas.html" id="btn-mis-citas" style="border-radius:20px;">
<img alt="mis citas" height="20" src="/Clinica/img/emojis/mis-citas.png" style="vertical-align:middle;" width="20"/>️ Mis Citas
                </a>
<span class="text-white fw-semibold d-none" id="saludo-usuario"></span>
<button class="btn btn-outline-light fw-semibold d-none" id="btn-cerrar-sesion" onclick="cerrarSesion()" style="border-radius:20px;">
<img alt="cerrar sesión" height="20" src="/Clinica/img/emojis/cerrar-sesion.png" style="vertical-align:middle;" width="20"/> Cerrar Sesión
                </button>
</div>
</div>
</div>
...
<!-- MODAL SIN SESION -->
<div aria-hidden="true" class="modal fade" id="modalSinSesion" tabindex="-1">
<div class="modal-dialog modal-dialog-centered">
<div class="modal-content">
<div class="modal-header text-white" style="background-color:#0E588E;">
<h5 class="modal-title"><img alt="advertencia" height="20" src="/Clinica/img/emojis/advertencia.png" style="vertical-align:middle;" width="20"/>️ Acceso Requerido</h5>
<button class="btn-close btn-close-white" data-bs-dismiss="modal" type="button"></button>
</div>
<div class="modal-body text-center py-4">
<p class="fs-5 mb-1">Para generar una cita debes</p>
<p class="fs-5 fw-bold mb-4">iniciar sesión o registrarte primero.</p>
<div class="d-flex justify-content-center gap-3">
<a class="btn btn-primary px-4" href="/Clinica/pages/login.html"><img alt="acceso seguro" height="20" src="/Clinica/img/emojis/acceso-seguro.png" style="vertical-align:middle;" width="20"/> Iniciar Sesión</a>
<a class="btn btn-outline-primary px-4" href="/Clinica/pages/register.html"><img alt="notas" height="20" src="/Clinica/img/emojis/notas.png" style="vertical-align:middle;" width="20"/> Registrarse</a>
</div>
</div>
</div>
</div>
...
<!-- MODAL CITA -->
<div aria-hidden="true" aria-labelledby="modalCitaLabel" class="modal fade" id="modalCita" tabindex="-1">
<div class="modal-dialog modal-lg modal-dialog-centered">
<div class="modal-content">
<div class="modal-header text-white" style="background-color:#0E588E;">
<h5 class="modal-title" id="modalCitaLabel"><img alt="calendario" height="20" src="/Clinica/img/emojis/calendario.png" style="vertical-align:middle;" width="20"/> Generar Cita Médica</h5>
<button aria-label="Cerrar" class="btn-close btn-close-white" data-bs-dismiss="modal" type="button"></button>
</div>
<div class="modal-body">
<form id="formCita">
<h6 class="fw-bold text-secondary mb-3">
<img alt="paciente" height="20" src="/Clinica/img/emojis/paciente.png" style="vertical-align:middle;" width="20"/>
    Datos del Paciente
    
</h6>
<div class="row">
<div class="col-md-6 mb-3"><label class="form-label">Nombres</label>
<input class="form-control" name="nombres" placeholder="Ej: Juan Carlos" required="" type="text"/></div>
<div class="col-md-6 mb-3"><label class="form-label">Apellidos</label>
<input class="form-control" name="apellidos" placeholder="Ej: López Pérez" required="" type="text"/></div>
</div>
<div class="row">
<div class="col-md-6 mb-3"><label class="form-label">DNI</label>
<input class="form-control" maxlength="8" name="dni" placeholder="Ej: 12345678" required="" type="text"/></div>
<div class="col-md-6 mb-3"><label class="form-label">Teléfono</label>
<input class="form-control" name="telefono" placeholder="Ej: 987654321" required="" type="tel"/></div>
</div>
<div class="mb-3"><label class="form-label">Correo electrónico</label>
<input class="form-control" name="correo" placeholder="Ej: juan@gmail.com" type="email"/></div>
<hr/>
<h6 class="fw-bold text-secondary mb-3"><img alt="hospital" height="20" src="/Clinica/img/emojis/hospital.png" style="vertical-align:middle;" width="20"/> Datos de la Cita</h6>
<div class="row">
<div class="col-md-6 mb-3"><label class="form-label">Especialidad</label>
...
<div class="col-md-6 mb-3"><label class="form-label">Médico</label>
<select class="form-select" id="doctor" name="doctor" required="">
<option disabled="" selected="" value="">Selecciona un Médico</option>
</select></div>
</div>
<div class="row">
<div class="col-md-6 mb-3"><label class="form-label">Fecha de la cita</label>
<input class="form-control" id="fecha" name="fecha" required="" type="date"/></div>
<div class="col-md-6 mb-3"><label class="form-label">Hora</label>
<select class="form-select" id="hora" name="hora" required="">
<option disabled="" selected="" value="">Selecciona una hora</option>
</select>
<div class="form-text text-muted mt-1" id="hora-ayuda">Selecciona médico y fecha para ver horarios disponibles.</div>
</div>
</div>
<div class="mb-3"><label class="form-label">Motivo de consulta</label>
<textarea class="form-control" name="motivo" placeholder="Describe brevemente el motivo de tu consulta..." required="" rows="3"></textarea></div>
<div class="modal-footer px-0 pb-0">
<button class="btn btn-secondary" data-bs-dismiss="modal" type="button">Cancelar</button>
<button class="btn text-white fw-semibold" style="background-color:#0E588E;" type="submit">Confirmar Cita</button>
</div>
</form>
</div>
</div>
...
<!-- MODAL CITA REGISTRADA -->
<div aria-hidden="true" class="modal fade" id="modalCitaExito" tabindex="-1">
<div class="modal-dialog modal-dialog-centered">
<div class="modal-content">
<div class="modal-header text-white" style="background-color:#0E588E;">
<h5 class="modal-title"><img alt="confirmado" height="20" src="/Clinica/img/emojis/confirmado.png" style="vertical-align:middle;" width="20"/> Cita Registrada</h5>
<button class="btn-close btn-close-white" data-bs-dismiss="modal" type="button"></button>
</div>
<div class="modal-body text-center py-4">
<div style="font-size:3.5rem;"><img alt="éxito" height="20" src="/Clinica/img/emojis/exito.png" style="vertical-align:middle;" width="20"/></div>
<h4 class="fw-bold mt-2 mb-1">¡Tu cita ha sido registrada!</h4>
<p class="text-muted mb-3">Nos pondremos en contacto contigo para confirmar los detalles.</p>
<div class="text-start bg-light rounded p-3 mb-3 small" id="resumen-cita"></div>
<button class="btn text-white fw-semibold px-5" data-bs-dismiss="modal" style="background-color:#0E588E;" type="button">Aceptar</button>
</div>
</div>
</div>
</div>
<!-- CARRUSEL -->
<div class="carousel slide" data-bs-interval="5000" data-bs-ride="carousel" id="Banner">
<div class="carousel-inner">
<div class="carousel-item active">
<div class="hero-slide hero-slide-1 d-flex align-items-center justify-content-center px-4">
<div class="text-center text-white" style="max-width:680px;">
<div class="hero-badge"><img alt="idea" height="20" src="/Clinica/img/emojis/idea.png" style="vertical-align:middle;" width="20"/> CONSEJOS DE SALUD</div>
<h1 class="fw-bold mb-3" style="font-size:clamp(1.8rem,4.5vw,3rem); line-height:1.15;">Tu bienestar empieza<br/><span style="color:#a8d8f0;">con la información correcta</span></h1>
<p class="mb-4 opacity-85" style="font-size:1.05rem;">Artículos y tips de salud redactados por nuestros especialistas.</p>
<div class="d-flex justify-content-center gap-3 flex-wrap">
<button class="hero-cta-btn" onclick="verificarSesionParaCita()"><img alt="calendario" height="20" src="/Clinica/img/emojis/calendario.png" style="vertical-align:middle;" width="20"/> Reservar Cita</button>
<a class="hero-cta-btn-outline" href="/Clinica/pages/index.html">← Volver al Inicio</a>
</div>
</div>
</div>
</div>
<div class="carousel-item">
<div class="hero-slide hero-slide-2 d-flex align-items-center justify-content-center px-4">
<div class="text-center text-white" style="max-width:680px;">
<div class="hero-badge"><img alt="manzana" height="20" src="/Clinica/img/emojis/vida-saludable.png" style="vertical-align:middle;" width="20"/> VIDA SALUDABLE</div>
<h1 class="fw-bold mb-3" style="font-size:clamp(1.8rem,4.5vw,3rem);">Pequeños cambios,<br/><span style="color:#a8f0e8;">grandes resultados</span></h1>
<p class="mb-4 opacity-85">Hábitos simples que pueden transformar tu salud a largo plazo.</p>
<button class="hero-cta-btn" onclick="verificarSesionParaCita()"><img alt="calendario" height="20" src="/Clinica/img/emojis/calendario.png" style="vertical-align:middle;" width="20"/> Reservar Cita</button>
</div>
</div>
</div>
<div class="carousel-item">
<div class="hero-slide hero-slide-3 d-flex align-items-center justify-content-center px-4">
<div class="text-center text-white" style="max-width:680px;">
<div class="hero-badge"><img alt="médico" height="20" src="/Clinica/img/emojis/estetoscopio.png" style="vertical-align:middle;" width="20"/> PREVENCIÓN</div>
<h1 class="fw-bold mb-3" style="font-size:clamp(1.8rem,4.5vw,3rem);">Prevenir es<br/><span style="color:#a8d8f0;">mejor que curar</span></h1>
<p class="mb-4 opacity-85">Conoce los chequeos y controles médicos que deberías hacerte cada año.</p>
<button class="hero-cta-btn" onclick="verificarSesionParaCita()"><img alt="calendario" height="20" src="/Clinica/img/emojis/calendario.png" style="vertical-align:middle;" width="20"/> Reservar Cita</button>
</div>
</div>
</div>
</div>
<button class="carousel-control-prev" data-bs-slide="prev" data-bs-target="#Banner" type="button">
<span class="carousel-control-prev-icon"></span>
</button>
<button class="carousel-control-next" data-bs-slide="next" data-bs-target="#Banner" type="button">
...
<h2 class="fw-bold mb-3" style="color:#0A3760;">Consejos de Salud</h2>
<p class="text-muted mx-auto" style="max-width:580px;">Información médica confiable redactada por nuestro equipo de especialistas para ayudarte a llevar una vida más saludable.</p>
<div class="d-flex flex-wrap justify-content-center gap-2 mt-4">
<button class="categoria-btn active">Todos</button>
<button class="categoria-btn"><img alt="cardiología" height="20" src="/Clinica/img/emojis/corazon-cardiologia.png" style="vertical-align:middle;" width="20"/> Cardiología</button>
<button class="categoria-btn"><img alt="neurología" height="20" src="/Clinica/img/emojis/cerebro.png" style="vertical-align:middle;" width="20"/> Neurología</button>
<button class="categoria-btn"><img alt="pediatría" height="20" src="/Clinica/img/emojis/pediatria.png" style="vertical-align:middle;" width="20"/> Pediatría</button>
<button class="categoria-btn"><img alt="ginecología" height="20" src="/Clinica/img/emojis/ginecologia.png" style="vertical-align:middle;" width="20"/> Ginecología</button>
<button class="categoria-btn"><img alt="traumatología" height="20" src="/Clinica/img/emojis/traumatologia.png" style="vertical-align:middle;" width="20"/> Traumatología</button>
<button class="categoria-btn"><img alt="dermatología" height="20" src="/Clinica/img/emojis/dermatologia.png" style="vertical-align:middle;" width="20"/> Dermatología</button>
</div>
</div>
</section>
...
<div class="container">
<h5 class="fw-bold mb-4" style="color:#0A3760;"><img alt="punto clave" height="20" src="/Clinica/img/emojis/punto-clave.png" style="vertical-align:middle;" width="20"/> Artículos Destacados</h5>
<div class="row g-4">
<div class="col-md-4">
<div class="articulo-card">
<div style="background:linear-gradient(135deg,#0E588E,#29A8EF);height:130px;display:flex;align-items:center;justify-content:center;font-size:4rem;"><img alt="cardiología" height="20" src="/Clinica/img/emojis/corazon-cardiologia.png" style="vertical-align:middle;" width="20"/></div>
<div class="p-4">
<span class="articulo-tag" style="background:#e8f4fd;color:#0E588E;">Cardiología</span>
<h6 class="fw-bold mt-2 mb-2" style="color:#0A3760;">5 hábitos para cuidar tu corazón todos los días</h6>
<p class="text-muted small">Caminar 30 minutos al día, reducir la sal y el estrés, dormir bien y evitar el tabaco son las claves para una salud cardiovascular óptima. Tu corazón te lo agradecerá.</p>
<div class="d-flex align-items-center justify-content-between mt-3">
<small class="text-muted"><img alt="doctor" height="20" src="/Clinica/img/emojis/doctor-avatar.png" style="vertical-align:middle;" width="20"/> Méd. Ney Flores</small>
<a class="fw-semibold small text-decoration-none" href="#" style="color:#0E588E;">Leer más →</a>
</div>
</div>
</div>
</div>
<div class="col-md-4">
<div class="articulo-card">
<div style="background:linear-gradient(135deg,#1a7a3c,#2ecc71);height:130px;display:flex;align-items:center;justify-content:center;font-size:4rem;"><img alt="pediatría" height="20" src="/Clinica/img/emojis/pediatria.png" style="vertical-align:middle;" width="20"/></div>
<div class="p-4">
<span class="articulo-tag" style="background:#e8f8ef;color:#1a7a3c;">Pediatría</span>
<h6 class="fw-bold mt-2 mb-2" style="color:#0A3760;">La importancia del calendario de vacunación</h6>
<p class="text-muted small">Mantener las vacunas al día protege a los niños de enfermedades graves y contribuye a la inmunidad colectiva. Conoce qué vacunas corresponden a cada etapa.</p>
<div class="d-flex align-items-center justify-content-between mt-3">
<small class="text-muted"><img alt="doctor" height="20" src="/Clinica/img/emojis/doctor-avatar.png" style="vertical-align:middle;" width="20"/> Méd. Enrique Quispe</small>
<a class="fw-semibold small text-decoration-none" href="#" style="color:#0E588E;">Leer más →</a>
</div>
</div>
</div>
...
<div class="col-md-4">
<div class="articulo-card">
<div style="background:linear-gradient(135deg,#7d3c98,#a569bd);height:130px;display:flex;align-items:center;justify-content:center;font-size:4rem;"><img alt="neurología" height="20" src="/Clinica/img/emojis/cerebro.png" style="vertical-align:middle;" width="20"/></div>
<div class="p-4">
<span class="articulo-tag" style="background:#f4ecfd;color:#7d3c98;">Neurología</span>
<h6 class="fw-bold mt-2 mb-2" style="color:#0A3760;">Cómo prevenir los dolores de cabeza frecuentes</h6>
<p class="text-muted small">La hidratación, el descanso regular y limitar el tiempo de pantalla antes de dormir reducen significativamente la frecuencia e intensidad de las migrañas.</p>
<div class="d-flex align-items-center justify-content-between mt-3">
<small class="text-muted"><img alt="doctor" height="20" src="/Clinica/img/emojis/doctor-avatar.png" style="vertical-align:middle;" width="20"/> Méd. Ney Flores</small>
<a class="fw-semibold small text-decoration-none" href="#" style="color:#0E588E;">Leer más →</a>
</div>
...
<!-- MÁS ARTÍCULOS -->
<section class="py-4" style="background:#f5f8fc;">
<div class="container">
<h5 class="fw-bold mb-4" style="color:#0A3760;"><img alt="libros" height="20" src="/Clinica/img/emojis/historial.png" style="vertical-align:middle;" width="20"/> Más artículos</h5>
<div class="row g-4">
<div class="col-md-4">
<div class="articulo-card">
<div style="background:linear-gradient(135deg,#c0392b,#e74c3c);height:110px;display:flex;align-items:center;justify-content:center;font-size:3.5rem;"><img alt="ginecología" height="20" src="/Clinica/img/emojis/ginecologia.png" style="vertical-align:middle;" width="20"/></div>
<div class="p-4">
<span class="articulo-tag" style="background:#fde8e8;color:#c0392b;">Ginecología</span>
<h6 class="fw-bold mt-2 mb-2" style="color:#0A3760;">Chequeos ginecológicos que toda mujer necesita</h6>
<p class="text-muted small">El Papanicolaou anual, la ecografía pélvica y la mamografía a partir de los 40 son esenciales para la detección temprana de enfermedades graves.</p>
<div class="d-flex align-items-center justify-content-between mt-3">
<small class="text-muted"><img alt="doctor" height="20" src="/Clinica/img/emojis/doctor-avatar.png" style="vertical-align:middle;" width="20"/> Méd. Aaron Vásquez</small>
<a class="fw-semibold small text-decoration-none" href="#" style="color:#0E588E;">Leer más →</a>
</div>
</div>
</div>
...
<div class="col-md-4">
<div class="articulo-card">
<div style="background:linear-gradient(135deg,#d35400,#e67e22);height:110px;display:flex;align-items:center;justify-content:center;font-size:3.5rem;"><img alt="traumatología" height="20" src="/Clinica/img/emojis/traumatologia.png" style="vertical-align:middle;" width="20"/></div>
<div class="p-4">
<span class="articulo-tag" style="background:#fef0e4;color:#d35400;">Traumatología</span>
<h6 class="fw-bold mt-2 mb-2" style="color:#0A3760;">Cómo cuidar tus articulaciones con el ejercicio</h6>
<p class="text-muted small">El calentamiento previo, el estiramiento posterior y el uso de calzado adecuado reducen hasta en un 60% el riesgo de lesiones articulares durante el deporte.</p>
<div class="d-flex align-items-center justify-content-between mt-3">
<small class="text-muted"><img alt="doctor" height="20" src="/Clinica/img/emojis/doctor-avatar.png" style="vertical-align:middle;" width="20"/> Méd. Joseph Ortega</small>
<a class="fw-semibold small text-decoration-none" href="#" style="color:#0E588E;">Leer más →</a>
</div>
</div>
</div>
...
<div class="col-md-4">
<div class="articulo-card">
<div style="background:linear-gradient(135deg,#16a085,#1abc9c);height:110px;display:flex;align-items:center;justify-content:center;font-size:3.5rem;"><img alt="dermatología" height="20" src="/Clinica/img/emojis/dermatologia.png" style="vertical-align:middle;" width="20"/></div>
<div class="p-4">
<span class="articulo-tag" style="background:#e0f8f4;color:#16a085;">Dermatología</span>
<h6 class="fw-bold mt-2 mb-2" style="color:#0A3760;">Protege tu piel del sol todo el año</h6>
<p class="text-muted small">Aplicar bloqueador solar FPS 30+ cada 2 horas, incluso en días nublados, es la medida más efectiva para prevenir el envejecimiento prematuro y el cáncer de piel.</p>
<div class="d-flex align-items-center justify-content-between mt-3">
<small class="text-muted"><img alt="doctor" height="20" src="/Clinica/img/emojis/doctor-avatar.png" style="vertical-align:middle;" width="20"/> Méd. Enrique Quispe</small>
<a class="fw-semibold small text-decoration-none" href="#" style="color:#0E588E;">Leer más →</a>
</div>
...
<div class="container">
<h5 class="fw-bold mb-4" style="color:#0A3760;"><img alt="inicio" height="20" src="/Clinica/img/emojis/tiktok.png" style="vertical-align:middle;" width="20"/> Tips Rápidos de Salud</h5>
<div class="row g-3">
<div class="col-md-4"><div class="tip-card"><div style="font-size:1.8rem;"><img alt="hidratación" height="20" src="/Clinica/img/emojis/hidratacion.png" style="vertical-align:middle;" width="20"/></div><p class="fw-bold small mb-1" style="color:#0A3760;">Hidratación diaria</p><p class="text-muted small mb-0">Bebe al menos 8 vasos de agua al día. La hidratación adecuada mejora la concentración, la digestión y la salud de la piel.</p></div></div>
<div class="col-md-4"><div class="tip-card" style="border-left-color:#1a7a3c;"><div style="font-size:1.8rem;"><img alt="nutrición" height="20" src="/Clinica/img/emojis/nutricion.png" style="vertical-align:middle;" width="20"/></div><p class="fw-bold small mb-1" style="color:#0A3760;">Incluye verduras en cada comida</p><p class="text-muted small mb-0">Las verduras aportan fibra, vitaminas y minerales esenciales. Apunta a que la mitad de tu plato sea de vegetales de colores variados.</p></div></div>
<div class="col-md-4"><div class="tip-card" style="border-left-color:#7d3c98;"><div style="font-size:1.8rem;"><img alt="descanso" height="20" src="/Clinica/img/emojis/descanso.png" style="vertical-align:middle;" width="20"/></div><p class="fw-bold small mb-1" style="color:#0A3760;">Duerme 7-8 horas</p><p class="text-muted small mb-0">El sueño reparador refuerza el sistema inmune, regula el metabolismo y mejora el estado de ánimo. Establece un horario fijo.</p></div></div>
<div class="col-md-4"><div class="tip-card" style="border-left-color:#d35400;"><div style="font-size:1.8rem;"><img alt="actividad" height="20" src="/Clinica/img/emojis/actividad.png" style="vertical-align:middle;" width="20"/></div><p class="fw-bold small mb-1" style="color:#0A3760;">Muévete 30 minutos al día</p><p class="text-muted small mb-0">Caminar, nadar o practicar yoga 30 minutos diarios reduce el riesgo de enfermedades cardiovasculares en un 35%.</p></div></div>
<div class="col-md-4"><div class="tip-card" style="border-left-color:#c0392b;"><div style="font-size:1.8rem;"><img alt="no fumar" height="20" src="/Clinica/img/emojis/no-fumar.png" style="vertical-align:middle;" width="20"/></div><p class="fw-bold small mb-1" style="color:#0A3760;">Evita el tabaco y el alcohol</p><p class="text-muted small mb-0">Dejar de fumar mejora la capacidad pulmonar en pocas semanas. Reducir el alcohol protege el hígado, el corazón y el cerebro.</p></div></div>
<div class="col-md-4"><div class="tip-card" style="border-left-color:#16a085;"><div style="font-size:1.8rem;"><img alt="médico" height="20" src="/Clinica/img/emojis/estetoscopio.png" style="vertical-align:middle;" width="20"/></div><p class="fw-bold small mb-1" style="color:#0A3760;">Chequeos médicos regulares</p><p class="text-muted small mb-0">Un control médico anual permite detectar enfermedades antes de que se vuelvan graves. Agenda tu cita hoy.</p></div></div>
</div>
</div>
</section>
<!-- CITA RESERVAR -->
<section class="py-5" style="background:linear-gradient(135deg,#0A3760,#0E588E);">
<div class="container text-center text-white">
<h3 class="fw-bold mb-3">¿Tienes dudas sobre tu salud?</h3>
<p class="opacity-85 mb-4" style="max-width:500px;margin:auto;">No esperes a que los síntomas empeoren. Nuestros especialistas están listos para atenderte y orientarte.</p>
<button class="hero-cta-btn" onclick="verificarSesionParaCita()"><img alt="calendario" height="20" src="/Clinica/img/emojis/calendario.png" style="vertical-align:middle;" width="20"/> Agenda tu consulta ahora</button>
</div>
</section>
<!-- FOOTER -->
...
<img alt="Logo" class="rounded" height="40" src="/Clinica/img/3063176.png"/>
<span class="fw-bold fs-5 text-white">Clínica José Pardo</span>
</div>
<p>Más de 35 años brindando atención médica de calidad con calidez humana a las familias de Lima y el Perú.</p>
<div class="d-flex gap-2 mt-3">
<a class="social-btn" href="https://www.facebook.com/profile.php?id=100065105306913#"><img alt="facebook" height="22" src="/Clinica/img/emojis/facebook.png" width="22"/></a>
<a class="social-btn" href="https://www.instagram.com/_joseph_otto_.py/"><img alt="instagram" height="22" src="/Clinica/img/emojis/instagram.png" width="22"/></a>
<a class="social-btn" href="https://x.com/fincito200"><img alt="twitter" height="22" src="/Clinica/img/emojis/twitter.png" width="22"/></a>
<a class="social-btn" href="https://www.tiktok.com/@aaron_xzz?lang=es"><img alt="TikTok" height="22" src="/Clinica/img/emojis/tiktok.png" width="22"/></a>
</div>
</div>
<div class="col-md-2">
<h6>Navegación</h6>
<a href="/Clinica/pages/index.html">Inicio</a>
<a href="/Clinica/pages/nosotros.html">Nosotros</a>
<a href="/Clinica/pages/nuestros-doctores.html">Nuestros Doctores</a>
<a href="/Clinica/pages/consejos-de-salud.html">Consejos de Salud</a>
<a href="/Clinica/pages/login.html">Iniciar sesión</a>
<a href="/Clinica/pages/mis-citas.html">Mis Citas</a>
</div>
<div class="col-md-3">
<h6>Especialidades</h6>
<a href="/Clinica/pages/nuestros-doctores.html">Medicina General</a>
<a href="/Clinica/pages/nuestros-doctores.html">Cardiología</a>
<a href="/Clinica/pages/nuestros-doctores.html">Pediatría</a>
<a href="/Clinica/pages/nuestros-doctores.html">Neurología</a>
<a href="/Clinica/pages/nuestros-doctores.html">Traumatología</a>
<a href="/Clinica/pages/nuestros-doctores.html">Ginecología</a>
</div>
<div class="col-md-3">
<h6>Contacto</h6>
<a href="#"><img alt="ubicación" height="20" src="/Clinica/img/emojis/ubicacion.png" style="vertical-align:middle;" width="20"/> Av. José Pardo 452, Miraflores</a>
<a href="tel:+5116114000"><img alt="teléfono" height="20" src="/Clinica/img/emojis/telefono.png" style="vertical-align:middle;" width="20"/> (01) 611-4000</a>
<a href="#"><img alt="email" height="20" src="/Clinica/img/emojis/email.png" style="vertical-align:middle;" width="20"/> atencion@clinicajosepardo.com.pe</a>
<a href="#"><img alt="teléfono" height="20" src="/Clinica/img/emojis/whatsapp.png" style="vertical-align:middle;" width="20"/> +51 987 654 321</a>
<p class="mt-2 mb-0"><img alt="reloj" height="20" src="/Clinica/img/emojis/reloj-alarma.png" style="vertical-align:middle;" width="20"/> Lun-Sáb: 7:00 am - 8:00 pm</p>
<p class="mb-0"><img alt="emergencias" height="20" src="/Clinica/img/emojis/emergencias.png" style="vertical-align:middle;" width="20"/> Emergencias: 24 horas</p>
</div>
</div>
<hr class="footer-divider"/>
<div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-2 text-center">
<p class="mb-0">© 2026 Clínica José Pardo · Todos los derechos reservados · Grupo 3</p>
<p class="mb-0"><a href="#">Política de privacidad</a> · <a href="#">Términos de uso</a></p>
</div>
</div>
</footer>

`;function sr(){return(0,j.jsx)(tr,{html:or,scripts:[`/Clinica/js/login.js`,`/Clinica/js/medicos.js`,`/Clinica/js/modal.js`,`/Clinica/js/notificaciones.js`],title:`Consejos de Salud — Clínica José Pardo`})}var cr=`
<!-- NAVBAR -->
<nav class="navbar navbar-expand-lg navbar-dark navbar-doctor">
<div class="container-fluid">
<a class="navbar-brand d-flex align-items-center gap-2" href="/Clinica/pages/doctor.html">
<img alt="Logo" class="rounded" height="36" src="/Clinica/img/3063176.png"/>
            José Pardo
        </a>
<div class="d-flex align-items-center gap-3">
<span class="badge-doctor-nav"><img alt="médico" height="20" src="/Clinica/img/emojis/estetoscopio.png" style="vertical-align:middle;" width="20"/> Panel Médico</span>
<span class="text-white fw-semibold small" id="nav-nombre-doctor"></span>
<button class="btn btn-outline-light btn-sm fw-semibold" onclick="cerrarSesionDoctor()"><img alt="cerrar sesión" height="20" src="/Clinica/img/emojis/cerrar-sesion.png" style="vertical-align:middle;" width="20"/> Salir</button>
</div>
</div>
</nav>
<!-- HEADER -->
...
<div class="container">
<h1 id="titulo-bienvenida"><img alt="doctor" height="20" src="/Clinica/img/emojis/doctor-avatar.png" style="vertical-align:middle;" width="20"/> Panel del Médico</h1>
<p>Gestiona tus citas del día y revisa el historial de pacientes</p>
<div class="stats-row">
<div class="stat-chip"><span id="total-citas">0</span>Total citas</div>
<div class="stat-chip"><span id="citas-pendientes">0</span>Pendientes</div>
<div class="stat-chip"><span id="citas-confirmadas">0</span>Confirmadas</div>
<div class="stat-chip"><span id="citas-atendidas">0</span>Atendidas</div>
</div>
</div>
</div>
<!-- FILTROS -->
...
<button class="btn-filtro active" onclick="filtrarCitas('todas', this)"><img alt="historial" height="20" src="/Clinica/img/emojis/historial.png" style="vertical-align:middle;" width="20"/> Todas</button>
<button class="btn-filtro" onclick="filtrarCitas('pendiente', this)"><img alt="tiempo" height="20" src="/Clinica/img/emojis/hora.png" style="vertical-align:middle;" width="20"/> Pendientes</button>
<button class="btn-filtro" onclick="filtrarCitas('confirmada', this)"><img alt="confirmado" height="20" src="/Clinica/img/emojis/confirmado.png" style="vertical-align:middle;" width="20"/> Confirmadas</button>
<button class="btn-filtro" onclick="filtrarCitas('atendida', this)"><img alt="completado" height="20" src="/Clinica/img/emojis/completado.png" style="vertical-align:middle;" width="20"/> Atendidas</button>
<div class="ms-auto">
<div style="display:inline-flex; align-items:center; gap:6px; background:white; border:1px solid #ced4da; border-radius:6px; padding:2px 8px;">
<img alt="buscar" height="18" src="/Clinica/img/emojis/buscar.png" style="display:block;" width="18"/>
<input class="form-control form-control-sm" id="buscar-paciente" oninput="renderCitas()" placeholder="Buscar paciente..." style="min-width:180px; border:none; box-shadow:none; padding-left:0;" type="text"/>
</div>
</div>
</div>
</div>
<!-- CITAS -->
<div class="seccion-citas">
<div class="container">
<h5 class="citas-titulo"><img alt="calendario" height="20" src="/Clinica/img/emojis/calendario.png" style="vertical-align:middle;" width="20"/> Citas asignadas a tu consulta</h5>
...
<div class="modal-header text-white modal-header-verde">
<h5 class="modal-title"><img alt="historial" height="20" src="/Clinica/img/emojis/historial.png" style="vertical-align:middle;" width="20"/> Detalle del Paciente</h5>
<button class="btn-close btn-close-white" data-bs-dismiss="modal" type="button"></button>
</div>
...
<!-- MODAL COMENTARIO DOCTOR -->
<div class="modal fade" id="modalComentario" tabindex="-1">
<div class="modal-dialog modal-dialog-centered">
<div class="modal-content border-0">
<div class="modal-header text-white" style="background-color:#1a7a4a;">
<h5 class="modal-title"><img alt="notas" height="20" src="/Clinica/img/emojis/notas.png" style="vertical-align:middle;" width="20"/> Comentario del Doctor</h5>
<button class="btn-close btn-close-white" data-bs-dismiss="modal" type="button"></button>
</div>
<div class="modal-body">
<p class="text-muted small mb-2">Este comentario quedará guardado en el historial del paciente.</p>
<div class="mb-3">
<label class="form-label fw-semibold">Paciente</label>
<input class="form-control" id="comentario-paciente" readonly="" type="text"/>
</div>
<div class="mb-3">
<label class="form-label fw-semibold">Comentario médico</label>
<textarea class="form-control" id="comentario-texto" placeholder="Escribe aquí el diagnóstico, observaciones o indicaciones..." rows="5"></textarea>
</div>
<div class="alert alert-success d-none" id="comentario-exito"><img alt="confirmado" height="20" src="/Clinica/img/emojis/confirmado.png" style="vertical-align:middle;" width="20"/> Comentario guardado correctamente.</div>
<div class="alert alert-danger d-none" id="comentario-error"><img alt="error" height="20" src="/Clinica/img/emojis/error.png" style="vertical-align:middle;" width="20"/> Error al guardar el comentario.</div>
</div>
<div class="modal-footer">
<button class="btn btn-secondary" data-bs-dismiss="modal" type="button">Cancelar</button>
<button class="btn text-white fw-semibold" onclick="guardarComentario()" style="background-color:#1a7a4a;" type="button"><img alt="guardar" height="20" src="/Clinica/img/emojis/guardar.png" style="vertical-align:middle;" width="20"/> Guardar comentario</button>
</div>
</div>
</div>
</div>
`;function lr(){return(0,j.jsx)(tr,{html:cr,scripts:[`/Clinica/js/doctor.js`],title:`Panel Médico Clínica José Pardo`})}var ur=`
<!-- FRANJA SUPERIOR -->
<div class="franja-contacto d-none d-md-block">
<div class="container-fluid px-4 d-flex justify-content-between align-items-center">
<div class="d-flex gap-4">
...
<ul class="navbar-nav me-auto mb-2 mb-lg-0">
<li class="nav-item">
<a aria-current="page" class="nav-link active" href="/Clinica/pages/index.html"><img alt="inicio" height="20" src="/Clinica/img/emojis/rayo.png" style="vertical-align:middle;" width="20"/> Inicio</a>
</li>
<li class="nav-item">
<a class="nav-link" href="https://www.instagram.com/_joseph_otto_.py/"><img alt="bot" height="20" src="/Clinica/img/emojis/bot.png" style="vertical-align:middle;" width="20"/> Redes</a>
</li>
<li class="nav-item dropdown">
<a aria-expanded="false" class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" id="navbarDropdown" role="button">
<img alt="opciones" height="20" src="/Clinica/img/emojis/pendiente.png" style="vertical-align:middle;" width="20"/> Opciones
                    </a>
<ul aria-labelledby="navbarDropdown" class="dropdown-menu">
<li><a class="dropdown-item" href="/Clinica/pages/nosotros.html"><img alt="persona" height="20" src="/Clinica/img/emojis/nosotros.png" style="vertical-align:middle;" width="20"/>‍<img alt="nosotros" height="20" src="/Clinica/img/emojis/nosotros.png" style="vertical-align:middle;" width="20"/> Nosotros</a></li>
<li><a class="dropdown-item" href="/Clinica/pages/nuestros-doctores.html"><img alt="doctor" height="20" src="/Clinica/img/emojis/doctor-avatar.png" style="vertical-align:middle;" width="20"/> Nuestros Doctores</a></li>
<li><a class="dropdown-item" href="/Clinica/pages/consejos-de-salud.html"><img alt="idea" height="20" src="/Clinica/img/emojis/idea.png" style="vertical-align:middle;" width="20"/> Consejos de Salud</a></li>
</ul>
</li>
</ul>
<div class="d-flex align-items-center gap-2 flex-wrap">
...
<input class="form-control" name="nombres" placeholder="Ej: Juan Carlos" required="" type="text"/>
</div>
<div class="col-md-6 mb-3">
<label class="form-label">Apellidos</label>
<input class="form-control" name="apellidos" placeholder="Ej: López Pérez" required="" type="text"/>
</div>
</div>
<div class="row">
<div class="col-md-6 mb-3">
<label class="form-label">DNI</label>
<input class="form-control" maxlength="8" name="dni" placeholder="Ej: 12345678" required="" type="text"/>
</div>
<div class="col-md-6 mb-3">
<label class="form-label">Teléfono</label>
<input class="form-control" name="telefono" placeholder="Ej: 987654321" required="" type="tel"/>
</div>
</div>
<div class="mb-3">
<label class="form-label">Correo electrónico</label>
<input class="form-control" name="correo" placeholder="Ej: juan@gmail.com" type="email"/>
</div>
<hr/>
<h6 class="fw-bold text-secondary mb-3"><img alt="hospital" height="20" src="/Clinica/img/emojis/hospital.png" style="vertical-align:middle;" width="20"/> Datos de la Cita</h6>
<div class="row">
...
<div class="form-text text-muted mt-1" id="hora-ayuda">
...
<textarea class="form-control" name="motivo" placeholder="Describe brevemente el motivo de tu consulta..." required="" rows="3"></textarea>
</div>
<div class="modal-footer px-0 pb-0">
<button class="btn btn-secondary" data-bs-dismiss="modal" type="button">Cancelar</button>
<button class="btn text-white fw-semibold" style="background-color: #0E588E;" type="submit">Confirmar Cita</button>
...
<div class="hero-badge"><img alt="hospital" height="20" src="/Clinica/img/emojis/hospital.png" style="vertical-align:middle;" width="20"/> CLÍNICA JOSÉ PARDO — LIMA, PERÚ</div>
<h1 class="fw-bold mb-3" style="font-size:clamp(2rem,5vw,3.2rem); line-height:1.15;">
                        Tu salud es nuestra<br/><span style="color:#a8d8f0;">mayor prioridad</span>
</h1>
<p class="mb-4 opacity-85" style="font-size:1.05rem;">
                        Más de 35 años brindando atención médica de calidad para ti y tu familia.
                    </p>
<div class="d-flex justify-content-center gap-3 flex-wrap mb-5">
<button class="hero-cta-btn" onclick="verificarSesionParaCita()"><img alt="calendario" height="20" src="/Clinica/img/emojis/calendario.png" style="vertical-align:middle;" width="20"/> Reservar Cita Ahora</button>
<a class="hero-cta-btn-outline" href="/Clinica/pages/nosotros.html">Conócenos →</a>
</div>
<div class="d-flex justify-content-center gap-3 flex-wrap">
<div class="hero-stat-box"><div class="num">35+</div><div class="lbl">Años de experiencia</div></div>
<div class="hero-stat-box"><div class="num">80k+</div><div class="lbl">Pacientes atendidos</div></div>
<div class="hero-stat-box"><div class="num">30+</div><div class="lbl">Especialidades</div></div>
<div class="hero-stat-box"><div class="num">24/7</div><div class="lbl">Emergencias</div></div>
</div>
</div>
</div>
</div>
...
<div class="carousel-item">
<div class="hero-slide hero-slide-2 d-flex align-items-center justify-content-center px-4">
<div class="text-center text-white" style="max-width:620px;">
<div class="hero-badge"><img alt="médico" height="20" src="/Clinica/img/emojis/estetoscopio.png" style="vertical-align:middle;" width="20"/> ESPECIALISTAS A TU SERVICIO</div>
<h1 class="fw-bold mb-3" style="font-size:clamp(1.8rem,5vw,3rem);">
                        Médicos expertos que<br/><span style="color:#a8f0e8;">realmente te escuchan</span>
</h1>
<p class="mb-4 opacity-85">
                        Nuestro equipo de especialistas está disponible para guiarte hacia una vida más saludable.
                    </p>
<button class="hero-cta-btn" onclick="verificarSesionParaCita()"><img alt="mis citas" height="20" src="/Clinica/img/emojis/mis-citas.png" style="vertical-align:middle;" width="20"/>️ Agenda tu consulta</button>
</div>
</div>
</div>
<!-- Slide 3 -->
...
<div class="hero-slide hero-slide-3 d-flex align-items-center justify-content-center px-4">
<div class="text-center text-white" style="max-width:620px;">
<div class="hero-badge"><img alt="laboratorio" height="20" src="/Clinica/img/emojis/laboratorio.png" style="vertical-align:middle;" width="20"/> TECNOLOGÍA DE VANGUARDIA</div>
<h1 class="fw-bold mb-3" style="font-size:clamp(1.8rem,5vw,3rem);">
                        Diagnósticos precisos para<br/><span style="color:#a8d8f0;">decisiones acertadas</span>
</h1>
<p class="mb-4 opacity-85">
                        Equipamiento moderno y laboratorio propio para resultados rápidos y confiables.
                    </p>
<button class="hero-cta-btn" onclick="verificarSesionParaCita()"><img alt="historial" height="20" src="/Clinica/img/emojis/historial.png" style="vertical-align:middle;" width="20"/> Ver nuestros servicios</button>
</div>
</div>
</div>
</div>
...
<!-- SERVICIOS RÁPIDOS -->
<div class="container seccion-ayuda">
<div class="text-center mb-5">
<h2 class="fw-bold" style="color:#0A3760;">¿En qué podemos ayudarte hoy?</h2>
<p class="text-muted">Accede rápidamente a nuestros principales servicios</p>
</div>
<div class="row g-4 justify-content-center">
<div class="col-md-3 col-sm-6">
<div class="card card-servicio h-100 text-center p-4">
<div class="card-top-bar"></div>
<div class="card-body pt-3">
<div class="card-icono mb-2"><img alt="cuidado" height="20" src="/Clinica/img/emojis/cuidado.png" style="vertical-align:middle;" width="20"/></div>
<h6 class="card-titulo">Servicios para ti</h6>
<p class="card-descripcion">Consultas, exámenes y tratamientos pensados en tu bienestar y el de tu familia.</p>
<a class="btn btn-naranja mt-auto" href="/Clinica/pages/servicios.html">Conoce más</a>
</div>
</div>
</div>
<div class="col-md-3 col-sm-6">
...
<div class="card-top-bar"></div>
<div class="card-body pt-3">
<div class="card-icono mb-2"><img alt="hospital" height="20" src="/Clinica/img/emojis/hospital.png" style="vertical-align:middle;" width="20"/></div>
<h6 class="card-titulo">Emergencias 24h</h6>
<p class="card-descripcion">Atención de urgencias disponible todos los días del año, sin excepción.</p>
<a class="btn btn-naranja mt-auto" href="tel:+5116114000">Llamar ahora</a>
</div>
</div>
</div>
<div class="col-md-3 col-sm-6">
...
<div class="card-top-bar"></div>
<div class="card-body pt-3">
<div class="card-icono mb-2"><img alt="médico" height="20" src="/Clinica/img/emojis/estetoscopio.png" style="vertical-align:middle;" width="20"/></div>
<h6 class="card-titulo">Staff Médico</h6>
<p class="card-descripcion">Conoce a nuestros especialistas, sus especialidades y horarios de atención.</p>
<a class="btn btn-naranja mt-auto" href="/Clinica/pages/nosotros.html">Ver médicos</a>
</div>
</div>
</div>
<div class="col-md-3 col-sm-6">
...
<div class="card-top-bar"></div>
<div class="card-body pt-3">
<div class="card-icono mb-2"><img alt="calendario" height="20" src="/Clinica/img/emojis/calendario.png" style="vertical-align:middle;" width="20"/></div>
<h6 class="card-titulo">Reserva tu cita</h6>
<p class="card-descripcion">Agenda tu consulta médica en línea de forma rápida, fácil y segura.</p>
<button class="btn btn-naranja mt-auto w-100" onclick="verificarSesionParaCita()">Reservar ahora</button>
</div>
</div>
</div>
</div>
...
<div class="col-6 col-md-3 stat-item">
<div class="num">5</div>
<div class="label">Médicos especialistas</div>
</div>
<div class="col-6 col-md-3 stat-item">
<div class="num">8</div>
<div class="label">Especialidades médicas</div>
</div>
</div>
</div>
</section>
...
<div class="container">
<div class="text-center mb-5">
<h2 class="fw-bold" style="color:#0A3760;">Nuestras Especialidades</h2>
<p class="text-muted">Un equipo multidisciplinario listo para cuidarte en cada área</p>
</div>
<div class="row g-3 justify-content-center">
<div class="col-auto"><div class="especialidad-pill"><span><img alt="cardiología" height="20" src="/Clinica/img/emojis/corazon-cardiologia.png" style="vertical-align:middle;" width="20"/></span> Cardiología</div></div>
<div class="col-auto"><div class="especialidad-pill"><span><img alt="neurología" height="20" src="/Clinica/img/emojis/cerebro.png" style="vertical-align:middle;" width="20"/></span> Neurología</div></div>
<div class="col-auto"><div class="especialidad-pill"><span><img alt="pediatría" height="20" src="/Clinica/img/emojis/pediatria.png" style="vertical-align:middle;" width="20"/></span> Pediatría</div></div>
<div class="col-auto"><div class="especialidad-pill"><span><img alt="traumatología" height="20" src="/Clinica/img/emojis/traumatologia.png" style="vertical-align:middle;" width="20"/></span> Traumatología</div></div>
<div class="col-auto"><div class="especialidad-pill"><span><img alt="ver" height="20" src="/Clinica/img/emojis/ver-contrasena.png" style="vertical-align:middle;" width="20"/>️</span> Oftalmología</div></div>
<div class="col-auto"><div class="especialidad-pill"><span><img alt="ginecología" height="20" src="/Clinica/img/emojis/ginecologia.png" style="vertical-align:middle;" width="20"/></span> Ginecología</div></div>
<div class="col-auto"><div class="especialidad-pill"><span><img alt="dermatología" height="20" src="/Clinica/img/emojis/dermatologia.png" style="vertical-align:middle;" width="20"/></span> Dermatología</div></div>
<div class="col-auto"><div class="especialidad-pill"><span><img alt="médico" height="20" src="/Clinica/img/emojis/estetoscopio.png" style="vertical-align:middle;" width="20"/></span> Medicina General</div></div>
</div>
<div class="text-center mt-4">
<a class="btn fw-semibold px-4 py-2 text-white" href="/Clinica/pages/nosotros.html" style="background:#0E588E; border-radius:25px;">
...
<!-- NUESTROS MEDICOS -->
<section class="py-5" style="background:#f5f8fc;">
<div class="container">
<div class="text-center mb-5">
<h2 class="fw-bold" style="color:#0A3760;">Conoce a nuestros Médicos</h2>
<p class="text-muted">Profesionales con vocación, experiencia y compromiso con tu salud</p>
</div>
<div class="row g-4 justify-content-center">
<div class="col-sm-6 col-md-4 col-lg">
<div class="card medico-card h-100">
<div class="medico-avatar"><img alt="doctor" height="20" src="/Clinica/img/emojis/doctor-avatar.png" style="vertical-align:middle;" width="20"/></div>
<div class="card-body text-center p-3">
<h6 class="fw-bold mb-1" style="color:#0A3760;">Méd. Joseph</h6>
<span class="badge" style="background:#e8f4fd;color:#0E588E;font-size:0.72rem;">Medicina General · Traumatología</span>
<p class="text-muted small mt-2 mb-3">12 años de experiencia en atención primaria y lesiones musculoesqueléticas.</p>
<button class="btn btn-sm w-100 text-white fw-semibold" onclick="verificarSesionParaCita()" style="background:#0E588E;border-radius:20px;">Reservar cita</button>
</div>
</div>
</div>
<div class="col-sm-6 col-md-4 col-lg">
...
<div class="medico-avatar"><img alt="doctor" height="20" src="/Clinica/img/emojis/doctor-avatar.png" style="vertical-align:middle;" width="20"/></div>
<div class="card-body text-center p-3">
<h6 class="fw-bold mb-1" style="color:#0A3760;">Méd. Eduardo</h6>
<span class="badge" style="background:#e8f4fd;color:#0E588E;font-size:0.72rem;">Medicina General · Oftalmología</span>
<p class="text-muted small mt-2 mb-3">10 años de trayectoria en diagnóstico visual y atención ambulatoria.</p>
<button class="btn btn-sm w-100 text-white fw-semibold" onclick="verificarSesionParaCita()" style="background:#0E588E;border-radius:20px;">Reservar cita</button>
</div>
</div>
</div>
...
<div class="medico-avatar"><img alt="doctor" height="20" src="/Clinica/img/emojis/doctor-avatar.png" style="vertical-align:middle;" width="20"/></div>
<div class="card-body text-center p-3">
<h6 class="fw-bold mb-1" style="color:#0A3760;">Méd. Ney</h6>
<span class="badge" style="background:#e8f4fd;color:#0E588E;font-size:0.72rem;">Cardiología · Neurología</span>
<p class="text-muted small mt-2 mb-3">15 años. Cardiólogo y neurólogo con formación en centros especializados de España.</p>
<button class="btn btn-sm w-100 text-white fw-semibold" onclick="verificarSesionParaCita()" style="background:#0E588E;border-radius:20px;">Reservar cita</button>
</div>
</div>
</div>
...
<div class="medico-avatar"><img alt="doctor" height="20" src="/Clinica/img/emojis/doctor-avatar.png" style="vertical-align:middle;" width="20"/></div>
<div class="card-body text-center p-3">
<h6 class="fw-bold mb-1" style="color:#0A3760;">Méd. Enrique</h6>
<span class="badge" style="background:#e8f4fd;color:#0E588E;font-size:0.72rem;">Pediatría · Dermatología</span>
<p class="text-muted small mt-2 mb-3">8 años dedicados a la salud infantil y enfermedades cutáneas.</p>
<button class="btn btn-sm w-100 text-white fw-semibold" onclick="verificarSesionParaCita()" style="background:#0E588E;border-radius:20px;">Reservar cita</button>
</div>
</div>
</div>
...
<div class="medico-avatar"><img alt="doctor" height="20" src="/Clinica/img/emojis/doctor-avatar.png" style="vertical-align:middle;" width="20"/></div>
<div class="card-body text-center p-3">
<h6 class="fw-bold mb-1" style="color:#0A3760;">Méd. Aaron</h6>
<span class="badge" style="background:#e8f4fd;color:#0E588E;font-size:0.72rem;">Ginecología</span>
<p class="text-muted small mt-2 mb-3">11 años de especialidad en salud femenina, atención prenatal y preventiva.</p>
<button class="btn btn-sm w-100 text-white fw-semibold" onclick="verificarSesionParaCita()" style="background:#0E588E;border-radius:20px;">Reservar cita</button>
</div>
</div>
</div>
...
<div class="container">
<div class="text-center mb-5">
<h2 class="fw-bold" style="color:#0A3760;">¿Cómo reservar tu cita?</h2>
<p class="text-muted">Solo 3 pasos simples para tu atención médica</p>
</div>
<div class="row g-4 text-center position-relative">
<div class="col-md-4 position-relative">
<div class="paso-num">1</div>
<h6 class="fw-bold" style="color:#0A3760;">Crea tu cuenta</h6>
<p class="text-muted small">Regístrate gratis con tu correo y datos básicos en menos de 2 minutos.</p>
</div>
<div class="col-md-4">
<div class="paso-num">2</div>
<h6 class="fw-bold" style="color:#0A3760;">Elige especialidad y médico</h6>
<p class="text-muted small">Selecciona la especialidad que necesitas, el doctor de tu preferencia, fecha y hora.</p>
</div>
<div class="col-md-4">
<div class="paso-num">3</div>
<h6 class="fw-bold" style="color:#0A3760;">¡Listo! Tu cita está confirmada</h6>
<p class="text-muted small">Recibirás la confirmación al instante. Podrás reprogramar cuando lo necesites.</p>
</div>
</div>
<div class="text-center mt-4">
<button class="btn fw-semibold px-5 py-2 text-white" onclick="verificarSesionParaCita()" style="background:#0E588E; border-radius:25px; font-size:1rem;">
<img alt="calendario" height="20" src="/Clinica/img/emojis/calendario.png" style="vertical-align:middle;" width="20"/> Reservar mi cita ahora
            </button>
</div>
</div>
</section>
...
<div class="container">
<div class="text-center mb-5">
<h2 class="fw-bold" style="color:#0A3760;">Lo que dicen nuestros pacientes</h2>
<p class="text-muted">Más de 80,000 familias confían en nosotros</p>
</div>
<div class="row g-4">
<div class="col-md-4">
<div class="testimonio-card">
<div class="stars mb-2"><img alt="estrella" height="20" src="/Clinica/img/emojis/estrella.png" style="vertical-align:middle;" width="20"/><img alt="estrella" height="20" src="/Clinica/img/emojis/estrella.png" style="vertical-align:middle;" width="20"/><img alt="estrella" height="20" src="/Clinica/img/emojis/estrella.png" style="vertical-align:middle;" width="20"/><img alt="estrella" height="20" src="/Clinica/img/emojis/estrella.png" style="vertical-align:middle;" width="20"/><img alt="estrella" height="20" src="/Clinica/img/emojis/estrella.png" style="vertical-align:middle;" width="20"/></div>
<p class="text-muted small mb-3">"La atención del Dr. Joseph fue excelente. Me explicó todo con mucha claridad y me sentí en muy buenas manos. Sin duda volvería."</p>
<div class="d-flex align-items-center gap-3">
<div class="avatar"><img alt="paciente" height="20" src="/Clinica/img/emojis/paciente.png" style="vertical-align:middle;" width="20"/></div>
<div>
<div class="fw-bold small" style="color:#0A3760;">María G.</div>
<div class="text-muted" style="font-size:0.75rem;">Paciente de Medicina General</div>
</div>
</div>
</div>
</div>
...
<div class="testimonio-card">
<div class="stars mb-2"><img alt="estrella" height="20" src="/Clinica/img/emojis/estrella.png" style="vertical-align:middle;" width="20"/><img alt="estrella" height="20" src="/Clinica/img/emojis/estrella.png" style="vertical-align:middle;" width="20"/><img alt="estrella" height="20" src="/Clinica/img/emojis/estrella.png" style="vertical-align:middle;" width="20"/><img alt="estrella" height="20" src="/Clinica/img/emojis/estrella.png" style="vertical-align:middle;" width="20"/><img alt="estrella" height="20" src="/Clinica/img/emojis/estrella.png" style="vertical-align:middle;" width="20"/></div>
<p class="text-muted small mb-3">"Reservar la cita por internet fue muy fácil. El sistema es intuitivo y el Dr. Ney fue muy profesional. Altamente recomendado."</p>
<div class="d-flex align-items-center gap-3">
<div class="avatar"><img alt="persona" height="20" src="/Clinica/img/emojis/nosotros.png" style="vertical-align:middle;" width="20"/></div>
<div>
<div class="fw-bold small" style="color:#0A3760;">Carlos M.</div>
<div class="text-muted" style="font-size:0.75rem;">Paciente de Cardiología</div>
</div>
</div>
</div>
</div>
...
<div class="testimonio-card">
<div class="stars mb-2"><img alt="estrella" height="20" src="/Clinica/img/emojis/estrella.png" style="vertical-align:middle;" width="20"/><img alt="estrella" height="20" src="/Clinica/img/emojis/estrella.png" style="vertical-align:middle;" width="20"/><img alt="estrella" height="20" src="/Clinica/img/emojis/estrella.png" style="vertical-align:middle;" width="20"/><img alt="estrella" height="20" src="/Clinica/img/emojis/estrella.png" style="vertical-align:middle;" width="20"/><img alt="estrella" height="20" src="/Clinica/img/emojis/estrella.png" style="vertical-align:middle;" width="20"/></div>
<p class="text-muted small mb-3">"Llevé a mi hijo con el Dr. Enrique y fue increíble. Muy paciente con los niños y muy buen diagnóstico. Toda la clínica es muy organizada."</p>
<div class="d-flex align-items-center gap-3">
<div class="avatar"><img alt="paciente" height="20" src="/Clinica/img/emojis/paciente.png" style="vertical-align:middle;" width="20"/></div>
<div>
<div class="fw-bold small" style="color:#0A3760;">Lucía P.</div>
<div class="text-muted" style="font-size:0.75rem;">Paciente de Pediatría</div>
</div>
</div>
</div>
</div>
...
<section class="py-5" style="background:#fff;">
<div class="container">
<div class="urgencias-banner d-flex flex-column flex-md-row align-items-center justify-content-between gap-4">
<div>
<h4 class="fw-bold mb-1"><img alt="emergencias" height="20" src="/Clinica/img/emojis/emergencias.png" style="vertical-align:middle;" width="20"/> ¿Tienes una emergencia?</h4>
<p class="mb-0 opacity-85">Nuestro servicio de emergencias está disponible las 24 horas, los 7 días de la semana. No esperes — llama ahora.</p>
</div>
<div class="d-flex gap-3 flex-shrink-0">
<a class="btn btn-light fw-bold px-4 py-2" href="tel:+5116114000" style="border-radius:25px; color:#c0392b;">
<img alt="teléfono" height="20" src="/Clinica/img/emojis/telefono.png" style="vertical-align:middle;" width="20"/> (01) 611-4000
                </a>
</div>
</div>
</div>
...
<div class="container">
<div class="text-center mb-5">
<h2 class="fw-bold" style="color:#0A3760;">Consejos de Salud</h2>
<p class="text-muted">Información útil de nuestro equipo médico para tu bienestar diario</p>
</div>
<div class="row g-4">
<div class="col-md-4">
<div class="card noticia-card h-100">
<div style="background:linear-gradient(135deg,#0E588E,#29A8EF); height:120px; display:flex; align-items:center; justify-content:center; font-size:3.5rem;"><img alt="cardiología" height="20" src="/Clinica/img/emojis/corazon-cardiologia.png" style="vertical-align:middle;" width="20"/></div>
<div class="card-body p-4">
<span class="noticia-tag">Cardiología</span>
<h6 class="fw-bold mt-2 mb-2" style="color:#0A3760;">5 hábitos para cuidar tu corazón</h6>
<p class="text-muted small">Caminar 30 minutos al día, reducir la sal, dormir bien y mantener el estrés bajo control son claves para una salud cardiovascular óptima.</p>
<a class="text-decoration-none fw-semibold small" href="#" style="color:#0E588E;">Leer más →</a>
</div>
</div>
</div>
<div class="col-md-4">
<div class="card noticia-card h-100">
<div style="background:linear-gradient(135deg,#1a7a3c,#2ecc71); height:120px; display:flex; align-items:center; justify-content:center; font-size:3.5rem;"><img alt="pediatría" height="20" src="/Clinica/img/emojis/pediatria.png" style="vertical-align:middle;" width="20"/></div>
<div class="card-body p-4">
<span class="noticia-tag" style="background:#e8f8ef;color:#1a7a3c;">Pediatría</span>
<h6 class="fw-bold mt-2 mb-2" style="color:#0A3760;">La importancia de las vacunas en niños</h6>
<p class="text-muted small">Mantener el calendario de vacunación al día protege a los niños de enfermedades graves y contribuye a la salud de toda la comunidad.</p>
<a class="text-decoration-none fw-semibold small" href="#" style="color:#0E588E;">Leer más →</a>
</div>
</div>
</div>
<div class="col-md-4">
<div class="card noticia-card h-100">
<div style="background:linear-gradient(135deg,#7d3c98,#a569bd); height:120px; display:flex; align-items:center; justify-content:center; font-size:3.5rem;"><img alt="neurología" height="20" src="/Clinica/img/emojis/cerebro.png" style="vertical-align:middle;" width="20"/></div>
<div class="card-body p-4">
<span class="noticia-tag" style="background:#f4ecfd;color:#7d3c98;">Neurología</span>
<h6 class="fw-bold mt-2 mb-2" style="color:#0A3760;">Cómo prevenir los dolores de cabeza</h6>
<p class="text-muted small">La hidratación, el descanso regular y evitar las pantallas antes de dormir pueden reducir significativamente la frecuencia de migrañas.</p>
<a class="text-decoration-none fw-semibold small" href="#" style="color:#0E588E;">Leer más →</a>
</div>
</div>
</div>
...
`;function dr(){return(0,j.jsx)(tr,{html:ur,scripts:[`/Clinica/js/login.js`,`/Clinica/js/medicos.js`,`/Clinica/js/modal.js`,`/Clinica/js/notificaciones.js`],title:`Clinica José Pardo`})}var fr=`
<div class="login-wrapper">
<!-- LOGO -->
<div class="login-logo">
<img alt="Logo" src="/Clinica/img/3063176.png"/>
<h2>Clínica José Pardo</h2>
<p>Selecciona tu tipo de acceso</p>
</div>
<!-- TABS -->
<div class="login-tabs">
<button class="login-tab-btn active" id="tab-paciente" onclick="switchTab('paciente')"><img alt="paciente" height="20" src="/Clinica/img/emojis/paciente.png" style="vertical-align:middle;" width="20"/> Paciente</button>
<button class="login-tab-btn" id="tab-doctor" onclick="switchTab('doctor')"><img alt="doctor" height="20" src="/Clinica/img/emojis/doctor-avatar.png" style="vertical-align:middle;" width="20"/> Doctor</button>
</div>
<!-- CARD -->
<div class="card-login">
<div class="alert alert-danger d-none py-2 small" id="alerta-error" role="alert">
<img alt="error" height="20" src="/Clinica/img/emojis/error.png" style="vertical-align:middle;" width="20"/> Correo o contraseña incorrectos.
        </div>
<!-- PANEL PACIENTE -->
<div class="panel-form active" id="panel-paciente">
<span class="badge-role badge-paciente"><img alt="hospital" height="20" src="/Clinica/img/emojis/hospital.png" style="vertical-align:middle;" width="20"/> Acceso Paciente</span>
<div class="mb-3">
<label class="form-label">Correo electrónico</label>
<input class="form-control" id="correo-paciente" placeholder="usuario@gmail.com" type="email"/>
</div>
<div class="mb-3">
<label class="form-label">Contraseña</label>
<input class="form-control" id="password-paciente" placeholder="••••••••" type="password"/>
</div>
<div class="hint-box"><img alt="llave" height="20" src="/Clinica/img/emojis/llave.png" style="vertical-align:middle;" width="20"/> Prueba: <strong>juan@gmail.com</strong> / <strong>1234</strong></div>
<br/>
<button class="btn-login-main" onclick="loginPaciente()">Ingresar como Paciente</button>
<hr class="divider"/>
<div class="d-flex justify-content-between align-items-center" style="font-size:0.87rem;">
<p class="register-link mb-0">¿No tienes cuenta? <a href="register.html">Regístrate aquí</a></p>
<a class="text-decoration-none fw-semibold" href="#" onclick="switchTab('recuperar')" style="color:#0E588E;">¿Olvidaste tu contraseña?</a>
</div>
</div>
<!-- PANEL DOCTOR -->
<div class="panel-form" id="panel-doctor">
<span class="badge-role badge-doctor"><img alt="médico" height="20" src="/Clinica/img/emojis/estetoscopio.png" style="vertical-align:middle;" width="20"/> Acceso Médico</span>
<div class="mb-3">
<label class="form-label">Correo del médico</label>
<input class="form-control" id="correo-doctor" placeholder="doctor@clinica.com" type="email"/>
</div>
<div class="mb-3">
<label class="form-label">Contraseña</label>
<input class="form-control" id="password-doctor" placeholder="••••••••" type="password"/>
</div>
<div class="hint-box doctor-hint"><img alt="llave" height="20" src="/Clinica/img/emojis/llave.png" style="vertical-align:middle;" width="20"/> Prueba: <strong>joseph@clinica.com</strong> / <strong>doctor123</strong></div>
<br/>
<button class="btn-login-main doctor" onclick="loginDoctor()">Ingresar como Doctor</button>
<hr class="divider"/>
<p class="register-link text-muted small text-center mb-0">Acceso restringido al personal médico</p>
</div>
<!-- PANEL RECUPERAR CONTRASEÑA -->
<div class="panel-form" id="panel-recuperar">
<span class="badge-role" style="background:#fff3cd;color:#856404;"><img alt="llave" height="20" src="/Clinica/img/emojis/llave.png" style="vertical-align:middle;" width="20"/> Restablecer Contraseña</span>
<!-- PASO 1: INGRESAR CORREO -->
<div id="recuperar-paso1">
<p class="text-muted small mb-3">Ingresa tu correo registrado y te pediremos una nueva contraseña.</p>
<div class="mb-3">
<label class="form-label">Correo electrónico</label>
<input class="form-control" id="recuperar-correo" placeholder="usuario@gmail.com" type="email"/>
</div>
<div class="alert alert-danger d-none py-2 small" id="recuperar-error"></div>
<button class="btn-login-main" onclick="verificarCorreoRecuperar()" style="background:linear-gradient(135deg,#856404,#b8860b);">
                    Continuar
                </button>
</div>
<!-- PASO 2: NUEVA CONTRASEÑA -->
<div class="d-none" id="recuperar-paso2">
<p class="text-muted small mb-3">Crea una nueva contraseña para tu cuenta.</p>
<div class="mb-3">
<label class="form-label">Nueva contraseña</label>
<input class="form-control" id="recuperar-nueva" placeholder="Mínimo 6 caracteres" type="password"/>
</div>
<div class="mb-3">
<label class="form-label">Confirmar contraseña</label>
<input class="form-control" id="recuperar-confirmar" placeholder="Repite la contraseña" type="password"/>
</div>
<div class="alert alert-danger d-none py-2 small" id="recuperar-error2"></div>
<div class="alert alert-success d-none py-2 small" id="recuperar-exito"></div>
<button class="btn-login-main" onclick="guardarNuevaPassword()" style="background:linear-gradient(135deg,#856404,#b8860b);">
                    Guardar nueva contraseña
                </button>
</div>
<hr class="divider"/>
<p class="text-center mb-0" style="font-size:0.87rem;">
<a class="text-decoration-none fw-semibold" href="#" onclick="switchTab('paciente')" style="color:#0E588E;">← Volver al inicio de sesión</a>
</p>
</div>
</div>
</div>
...
`;function pr(){return(0,j.jsx)(tr,{html:fr,scripts:[`/Clinica/js/login.js`],title:`Login Clínica José Pardo`})}var mr=`
<!-- FRANJA SUPERIOR -->
<div class="franja-contacto d-none d-md-block">
<div class="container-fluid px-4 d-flex justify-content-between align-items-center">
<div class="d-flex gap-4">
...
<!-- NAVBAR -->
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #0E588E;">
<div class="container-fluid">
<a class="navbar-brand d-flex align-items-center gap-2" href="/Clinica/pages/index.html">
<img alt="Logo" class="rounded" height="40" src="/Clinica/img/3063176.png"/>
<span class="fw-bold">José Pardo</span>
...
<a class="btn btn-outline-light fw-semibold" href="/Clinica/pages/mis-citas.html">
                ← Mis Citas
            </a>
<span class="text-white fw-semibold d-none" id="saludo-usuario"></span>
<button class="btn btn-outline-light fw-semibold d-none" id="btn-cerrar-sesion" onclick="cerrarSesion()">
<img alt="cerrar sesión" height="20" src="/Clinica/img/emojis/cerrar-sesion.png" style="vertical-align:middle;" width="20"/> Cerrar Sesión
            </button>
</div>
</div>
...
<h2 class="fw-bold mb-1" style="color: #0E588E;"><img alt="perfil" height="20" src="/Clinica/img/emojis/perfil.png" width="20"/> Mi Perfil</h2>
<p class="text-muted mb-4">Actualiza tu información personal.</p>
<div class="alert alert-success d-none py-2" id="alerta-exito"></div>
<div class="alert alert-danger d-none py-2" id="alerta-error"></div>
<div class="card shadow-sm border-0 p-4">
<div class="row">
<div class="col-md-6 mb-3">
<label class="form-label fw-semibold">Nombres</label>
<input class="form-control" id="p-nombres" placeholder="Juan Carlos" type="text"/>
</div>
<div class="col-md-6 mb-3">
<label class="form-label fw-semibold">Apellidos</label>
<input class="form-control" id="p-apellidos" placeholder="López Pérez" type="text"/>
</div>
</div>
<div class="row">
<div class="col-md-6 mb-3">
<label class="form-label fw-semibold">DNI</label>
<input class="form-control" id="p-dni" maxlength="8" placeholder="12345678" type="text"/>
</div>
<div class="col-md-6 mb-3">
<label class="form-label fw-semibold">Teléfono</label>
<input class="form-control" id="p-telefono" maxlength="9" placeholder="987654321" type="tel"/>
</div>
</div>
<div class="mb-3">
<label class="form-label fw-semibold">Correo electrónico</label>
<input class="form-control" id="p-correo" placeholder="ejemplo@gmail.com" type="email"/>
</div>
<hr/>
<p class="text-muted small mb-3"><img alt="contraseña" height="20" src="/Clinica/img/emojis/contrasena.png" style="vertical-align:middle;" width="20"/> Cambiar contraseña (dejar en blanco para no cambiarla)</p>
<div class="row">
<div class="col-md-6 mb-3">
<label class="form-label fw-semibold">Nueva contraseña</label>
<div class="input-pass">
<input class="form-control" id="p-pass-nueva" placeholder="••••••••" type="password"/>
<button class="toggle-pass" onclick="togglePass('p-pass-nueva', this)" type="button"><img alt="ver" height="20" src="/Clinica/img/emojis/ver-contrasena.png" style="vertical-align:middle;" width="20"/>️</button>
</div>
</div>
<div class="col-md-6 mb-3">
<label class="form-label fw-semibold">Confirmar contraseña</label>
<div class="input-pass">
<input class="form-control" id="p-pass-confirmar" placeholder="••••••••" type="password"/>
<button class="toggle-pass" onclick="togglePass('p-pass-confirmar', this)" type="button"><img alt="ver" height="20" src="/Clinica/img/emojis/ver-contrasena.png" style="vertical-align:middle;" width="20"/>️</button>
</div>
</div>
</div>
<button class="btn text-white fw-semibold w-100 mt-2" onclick="guardarPerfil()" style="background-color: #0E588E;">
<img alt="guardar" height="20" src="/Clinica/img/emojis/guardar.png" style="vertical-align:middle;" width="20"/> Guardar cambios
            </button>
</div>
</div>
</div>

`;function hr(){return(0,j.jsx)(tr,{html:mr,scripts:[`/Clinica/js/login.js`],title:`Mi Perfil - Clínica José Pardo`})}var gr=`
<!-- FRANJA SUPERIOR -->
<div class="franja-contacto d-none d-md-block">
<div class="container-fluid px-4 d-flex justify-content-between align-items-center">
<div class="d-flex gap-4">
...
<!-- FIN CAMPANA -->
<a class="btn btn-outline-light fw-semibold" href="/Clinica/pages/index.html">
            ← Volver al Inicio
            </a>
<a class="btn btn-outline-light fw-semibold" href="/Clinica/pages/mi-perfil.html">
<img alt="perfil" height="20" src="/Clinica/img/emojis/perfil.png" width="20"/> Mi Perfil
            </a>
<span class="text-white fw-semibold d-none" id="saludo-usuario"></span>
<button class="btn btn-outline-light fw-semibold d-none" id="btn-cerrar-sesion" onclick="cerrarSesion()">
<img alt="cerrar sesión" height="20" src="/Clinica/img/emojis/cerrar-sesion.png" style="vertical-align:middle;" width="20"/> Cerrar Sesión
...
<!-- CONTENIDO -->
<div class="container py-5">
<h2 class="fw-bold mb-1" style="color: #0E588E;"><img alt="mis citas" height="20" src="/Clinica/img/emojis/mis-citas.png" style="vertical-align:middle;" width="20"/>️ Mis Citas Programadas</h2>
<p class="text-muted mb-4">Aquí puedes ver todas tus citas médicas registradas.</p>
...
<div class="modal-content">
<div class="modal-header text-white" style="background-color: #0E588E;">
<h5 class="modal-title"><img alt="editar" height="20" src="/Clinica/img/emojis/editar.png" style="vertical-align:middle;" width="20"/>️ Reprogramar Cita</h5>
<button class="btn-close btn-close-white" data-bs-dismiss="modal" type="button"></button>
</div>
<div class="modal-body">
<input id="editar-index" type="hidden"/>
<p class="fw-semibold text-secondary mb-3" id="editar-doctor-info"></p>
<div class="mb-3">
<label class="form-label fw-semibold"><img alt="calendario" height="20" src="/Clinica/img/emojis/calendario.png" style="vertical-align:middle;" width="20"/> Nueva Fecha</label>
<input class="form-control" id="editar-fecha" onchange="actualizarHorasEditar()" type="date"/>
<small class="text-danger" id="editar-aviso-dia"></small>
<div class="form-text text-muted">Solo puedes reprogramar con al menos 3 días de anticipación.</div>
</div>
<div class="mb-3">
<label class="form-label fw-semibold"><img alt="alarma" height="20" src="/Clinica/img/emojis/reloj-alarma.png" style="vertical-align:middle;" width="20"/> Nueva Hora</label>
<select class="form-select" id="editar-hora">
<option disabled="" selected="" value="">Selecciona una hora</option>
</select>
</div>
<div class="mb-3">
<label class="form-label fw-semibold"><img alt="notas" height="20" src="/Clinica/img/emojis/notas.png" style="vertical-align:middle;" width="20"/> Motivo de consulta</label>
<textarea class="form-control" id="editar-motivo" rows="3"></textarea>
</div>
</div>
<div class="modal-footer">
<button class="btn btn-secondary" data-bs-dismiss="modal" type="button">Cancelar</button>
<button class="btn text-white fw-semibold" onclick="guardarEdicion()" style="background-color: #0E588E;" type="button">
<img alt="guardar" height="20" src="/Clinica/img/emojis/guardar.png" style="vertical-align:middle;" width="20"/> Guardar cambios
                </button>
</div>
</div>
...
`;function _r(){return(0,j.jsx)(tr,{html:gr,scripts:[`/Clinica/js/login.js`,`/Clinica/js/mis-citas.js`,`/Clinica/js/notificaciones.js`],title:`Mis Citas - Clínica José Pardo`})}var vr=`
<!-- FRANJA SUPERIOR -->
<div class="franja-contacto d-none d-md-block">
<div class="container-fluid px-4 d-flex justify-content-between align-items-center">
<div class="d-flex gap-4">
...
<a aria-expanded="false" class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" id="navbarDropdown" role="button"><img alt="opciones" height="20" src="/Clinica/img/emojis/pendiente.png" style="vertical-align:middle;" width="20"/> Opciones</a>
<ul aria-labelledby="navbarDropdown" class="dropdown-menu">
<li><a aria-current="page" class="dropdown-item active" href="/Clinica/pages/nosotros.html"><img alt="persona" height="20" src="/Clinica/img/emojis/nosotros.png" style="vertical-align:middle;" width="20"/>‍<img alt="nosotros" height="20" src="/Clinica/img/emojis/nosotros.png" style="vertical-align:middle;" width="20"/> Nosotros</a></li>
<li><a class="dropdown-item" href="/Clinica/pages/nuestros-doctores.html"><img alt="doctor" height="20" src="/Clinica/img/emojis/doctor-avatar.png" style="vertical-align:middle;" width="20"/> Nuestros Doctores</a></li>
<li><a class="dropdown-item" href="/Clinica/pages/consejos-de-salud.html"><img alt="idea" height="20" src="/Clinica/img/emojis/idea.png" style="vertical-align:middle;" width="20"/> Consejos de Salud</a></li>
</ul>
</li>
...
<div class="text-center text-white" style="max-width:680px;">
<div class="hero-badge"><img alt="hospital" height="20" src="/Clinica/img/emojis/hospital.png" style="vertical-align:middle;" width="20"/> CLÍNICA JOSÉ PARDO — LIMA, PERÚ</div>
<h1 class="fw-bold mb-3" style="font-size:clamp(1.8rem,4.5vw,3rem); line-height:1.15;">35 años construyendo<br/><span style="color:#a8d8f0;">confianza médica</span></h1>
<p class="mb-4 opacity-85" style="font-size:1.05rem;">Conoce nuestra historia, misión y el equipo humano que nos distingue.</p>
<div class="d-flex justify-content-center gap-3 flex-wrap">
<button class="hero-cta-btn" onclick="verificarSesionParaCita()"><img alt="calendario" height="20" src="/Clinica/img/emojis/calendario.png" style="vertical-align:middle;" width="20"/> Reservar Cita</button>
<a class="hero-cta-btn-outline" href="/Clinica/pages/index.html">← Volver al Inicio</a>
</div>
...
<div class="hero-slide hero-slide-2 d-flex align-items-center justify-content-center px-4">
<div class="text-center text-white" style="max-width:680px;">
<div class="hero-badge"><img alt="objetivo" height="20" src="/Clinica/img/emojis/objetivo.png" style="vertical-align:middle;" width="20"/> NUESTRA MISIÓN</div>
<h1 class="fw-bold mb-3" style="font-size:clamp(1.8rem,4.5vw,3rem);">Salud de calidad,<br/><span style="color:#a8f0e8;">al alcance de todos</span></h1>
<p class="mb-4 opacity-85">Nos comprometemos a brindar atención médica accesible, humana y de excelencia.</p>
<button class="hero-cta-btn" onclick="verificarSesionParaCita()"><img alt="calendario" height="20" src="/Clinica/img/emojis/calendario.png" style="vertical-align:middle;" width="20"/> Reservar Cita</button>
</div>
</div>
</div>
...
<div class="hero-slide hero-slide-3 d-flex align-items-center justify-content-center px-4">
<div class="text-center text-white" style="max-width:680px;">
<div class="hero-badge"><img alt="ubicación" height="20" src="/Clinica/img/emojis/ubicacion.png" style="vertical-align:middle;" width="20"/> ENCUÉNTRANOS</div>
<h1 class="fw-bold mb-3" style="font-size:clamp(1.8rem,4.5vw,3rem);">Estamos en<br/><span style="color:#a8d8f0;">el corazón de Miraflores</span></h1>
<p class="mb-4 opacity-85">Av. José Pardo 452, Lima. Atención Lun-Sáb de 7:00 am a 8:00 pm.</p>
<button class="hero-cta-btn" onclick="verificarSesionParaCita()"><img alt="calendario" height="20" src="/Clinica/img/emojis/calendario.png" style="vertical-align:middle;" width="20"/> Reservar Cita</button>
</div>
</div>
</div>
...
<div class="col-lg-6">
<span class="badge mb-3 px-3 py-2 fs-6" style="background:#e8f4fd;color:#0E588E;"><img alt="hospital" height="20" src="/Clinica/img/emojis/hospital.png" style="vertical-align:middle;" width="20"/> Quiénes Somos</span>
<h2 class="fw-bold mb-3" style="color:#0A3760;">Clínica José Pardo —<br/>35 años cuidando tu salud</h2>
<p class="text-muted mb-3">Fundada en 1990 en el corazón de Lima, la <strong>Clínica José Pardo</strong> nació con una misión clara: brindar atención médica de calidad, accesible y humana a cada paciente que cruza nuestras puertas.</p>
<p class="text-muted mb-4">A lo largo de más de tres décadas, hemos crecido hasta convertirnos en uno de los centros de salud más reconocidos de la región, integrando tecnología de vanguardia con el trato cálido y personalizado que nos caracteriza.</p>
<div class="row g-3 text-center">
<div class="col-4"><div class="stat-box"><div class="num">35+</div><div class="lbl">Años de exp.</div></div></div>
<div class="col-4"><div class="stat-box"><div class="num">80k+</div><div class="lbl">Pacientes</div></div></div>
<div class="col-4"><div class="stat-box"><div class="num">30+</div><div class="lbl">Especialidades</div></div></div>
</div>
</div>
<div class="col-lg-6 text-center">
<div class="rounded-4 overflow-hidden shadow-lg d-inline-block" style="background:linear-gradient(135deg,#0A3760,#29A8EF);padding:3rem 2.5rem;">
<div style="font-size:7rem;"><img alt="hospital" height="20" src="/Clinica/img/emojis/hospital.png" style="vertical-align:middle;" width="20"/></div>
<div class="text-white fw-bold fs-4 mt-2">Clínica José Pardo</div>
<div class="text-white opacity-75 small">Lima, Perú — Desde 1990</div>
</div>
</div>
</div>
</div>
...
<div class="container">
<div class="text-center mb-5">
<h2 class="fw-bold" style="color:#0A3760;">Nuestros pilares institucionales</h2>
<p class="text-muted">Lo que nos guía cada día en nuestra labor médica</p>
</div>
<div class="row g-4">
<div class="col-md-4"><div class="pilar-card">
<div style="font-size:3rem;"><img alt="objetivo" height="20" src="/Clinica/img/emojis/objetivo.png" style="vertical-align:middle;" width="20"/></div>
<h5 class="fw-bold mt-3" style="color:#0E588E;">Misión</h5>
<p class="text-muted small mt-2">Brindar atención médica integral, oportuna y de alta calidad, centrada en el bienestar de nuestros pacientes y sus familias, con personal comprometido y tecnología de vanguardia.</p>
</div></div>
<div class="col-md-4"><div class="pilar-card">
<div style="font-size:3rem;"><img alt="visión" height="20" src="/Clinica/img/emojis/telescopio.png" style="vertical-align:middle;" width="20"/></div>
<h5 class="fw-bold mt-3" style="color:#0E588E;">Visión</h5>
<p class="text-muted small mt-2">Ser la clínica líder del Perú en salud preventiva y especializada, reconocida por la excelencia de su atención, la innovación de sus procesos y el impacto positivo en la comunidad.</p>
</div></div>
<div class="col-md-4"><div class="pilar-card">
<div style="font-size:3rem;"><img alt="valores" height="20" src="/Clinica/img/emojis/diamante.png" style="vertical-align:middle;" width="20"/></div>
<h5 class="fw-bold mt-3" style="color:#0E588E;">Valores</h5>
<p class="text-muted small mt-2">Nos guían la <strong>ética</strong>, el <strong>respeto</strong> por la dignidad del paciente, la <strong>excelencia clínica</strong>, la <strong>empatía</strong> en cada consulta y el compromiso con la <strong>mejora continua</strong>.</p>
</div></div>
</div>
</div>
</section>
...
<div class="container">
<div class="text-center mb-5">
<h2 class="fw-bold" style="color:#0A3760;">Nuestra Historia</h2>
<p class="text-muted">Tres décadas de crecimiento al servicio de la salud</p>
</div>
...
<div><strong style="color:#0E588E;">1990 — Fundación</strong><br/><span class="text-muted small">El Dr. José Pardo inaugura la clínica con 3 consultorios y un equipo de 8 personas comprometidas con la salud de Miraflores.</span></div>
</div>
<div class="lt-item">
<div class="lt-punto"></div>
<div><strong style="color:#0E588E;">1998 — Primera expansión</strong><br/><span class="text-muted small">Se amplían las instalaciones con un laboratorio clínico propio y se incorporan 5 nuevas especialidades médicas.</span></div>
</div>
<div class="lt-item">
<div class="lt-punto"></div>
<div><strong style="color:#0E588E;">2005 — Servicio de Emergencias 24h</strong><br/><span class="text-muted small">Implementamos nuestra unidad de emergencias con atención permanente y equipos de diagnóstico avanzado.</span></div>
</div>
<div class="lt-item">
<div class="lt-punto"></div>
<div><strong style="color:#0E588E;">2015 — Acreditación internacional</strong><br/><span class="text-muted small">Recibimos la certificación de calidad en gestión hospitalaria, convirtiéndonos en referente regional de buenas prácticas médicas.</span></div>
</div>
<div class="lt-item">
<div class="lt-punto"></div>
<div><strong style="color:#0E588E;">2024 — Portal digital de citas</strong><br/><span class="text-muted small">Lanzamos nuestra plataforma online para que los pacientes puedan agendar, reprogramar y gestionar sus citas desde cualquier dispositivo.</span></div>
</div>
</div>
</div>
</div>
...
<div class="container">
<div class="text-center mb-5">
<h2 class="fw-bold text-white">¿Por qué elegirnos?</h2>
<p style="color:rgba(255,255,255,0.75);">Razones que nos distinguen cada día</p>
</div>
<div class="row g-4 text-white text-center">
<div class="col-md-3 col-sm-6"><div style="font-size:2.5rem;"><img alt="calendario" height="20" src="/Clinica/img/emojis/calendario.png" style="vertical-align:middle;" width="20"/></div><h6 class="fw-bold">Citas en línea 24/7</h6><p class="small opacity-75">Reserva tu consulta desde cualquier dispositivo, a cualquier hora, sin filas.</p></div>
<div class="col-md-3 col-sm-6"><div style="font-size:2.5rem;"><img alt="laboratorio" height="20" src="/Clinica/img/emojis/laboratorio.png" style="vertical-align:middle;" width="20"/></div><h6 class="fw-bold">Tecnología avanzada</h6><p class="small opacity-75">Equipos de diagnóstico de última generación para resultados precisos y rápidos.</p></div>
<div class="col-md-3 col-sm-6"><div style="font-size:2.5rem;"><img alt="equipo" height="20" src="/Clinica/img/emojis/equipo.png" style="vertical-align:middle;" width="20"/></div><h6 class="fw-bold">Atención personalizada</h6><p class="small opacity-75">Cada paciente recibe un trato único, con tiempo y dedicación en cada consulta.</p></div>
<div class="col-md-3 col-sm-6"><div style="font-size:2.5rem;"><img alt="emergencias" height="20" src="/Clinica/img/emojis/emergencias.png" style="vertical-align:middle;" width="20"/></div><h6 class="fw-bold">Emergencias 24 horas</h6><p class="small opacity-75">Servicio de urgencias disponible todos los días del año, sin excepción.</p></div>
</div>
</div>
</section>
...
<div class="container">
<div class="text-center mb-5">
<h2 class="fw-bold" style="color:#0A3760;">Encuéntranos</h2>
<p class="text-muted">Estamos cerca de ti para cuando más nos necesitas</p>
</div>
<div class="row g-4 align-items-stretch">
<div class="col-md-5">
<div class="card border-0 shadow-sm rounded-4 p-4 h-100">
<h5 class="fw-bold mb-4" style="color:#0E588E;"><img alt="ubicación" height="20" src="/Clinica/img/emojis/ubicacion.png" style="vertical-align:middle;" width="20"/> Información de Contacto</h5>
<ul class="list-unstyled text-muted">
<li class="mb-3"><img alt="punto clave" height="20" src="/Clinica/img/emojis/punto-clave.png" style="vertical-align:middle;" width="20"/> <strong>Dirección:</strong> Calle Francisco 170, Comas 15314</li>
<li class="mb-3"><img alt="teléfono" height="20" src="/Clinica/img/emojis/telefono.png" style="vertical-align:middle;" width="20"/> <strong>Central:</strong> (01) 611-4000</li>
<li class="mb-3"><img alt="teléfono" height="20" src="/Clinica/img/emojis/whatsapp.png" style="vertical-align:middle;" width="20"/> <strong>WhatsApp:</strong> +51 987 654 321</li>
<li class="mb-3"><img alt="email" height="20" src="/Clinica/img/emojis/email.png" style="vertical-align:middle;" width="20"/> <strong>Correo:</strong> atencion@clinicajosepardo.com.pe</li>
<li class="mb-3"><img alt="reloj" height="20" src="/Clinica/img/emojis/reloj-alarma.png" style="vertical-align:middle;" width="20"/> <strong>Horario:</strong> Lunes a Sábado — 7:00 am a 8:00 pm</li>
<li><img alt="emergencias" height="20" src="/Clinica/img/emojis/emergencias.png" style="vertical-align:middle;" width="20"/> <strong>Emergencias:</strong> 24 horas / 7 días</li>
</ul>
<div class="mt-4 d-flex gap-2 flex-wrap">
<button class="btn btn-sm fw-semibold text-white px-3" onclick="verificarSesionParaCita()" style="background:#0E588E;border-radius:20px;"><img alt="calendario" height="20" src="/Clinica/img/emojis/calendario.png" style="vertical-align:middle;" width="20"/> Reservar Cita</button>
<a class="btn btn-sm btn-outline-secondary px-3" href="tel:+5116114000" style="border-radius:20px;"><img alt="teléfono" height="20" src="/Clinica/img/emojis/telefono.png" style="vertical-align:middle;" width="20"/> Llamar</a>
</div>
</div>
</div>
<div class="col-md-7">
<div class="card border-0 shadow-sm rounded-4 overflow-hidden h-100" style="min-height:280px;">
<iframe allowfullscreen="" height="100%" loading="lazy" referrerpolicy="no-referrer-when-downgrade" src="https://maps.google.com/maps?q=Av.+Jos%C3%A9+Pardo+452,+Miraflores,+Lima&amp;output=embed" style="border:0;min-height:280px;" width="100%">
</iframe>
</div>
</div>
</div>
...
<div class="container">
<div class="urgencias-banner d-flex flex-column flex-md-row align-items-center justify-content-between gap-4">
<div><h4 class="fw-bold mb-1"><img alt="emergencias" height="20" src="/Clinica/img/emojis/emergencias.png" style="vertical-align:middle;" width="20"/> ¿Tienes una emergencia?</h4>
<p class="mb-0 opacity-85">Nuestro servicio de emergencias está disponible las 24 horas, los 7 días de la semana.</p></div>
<a class="btn btn-light fw-bold px-4 py-2" href="tel:+5116114000" style="border-radius:25px;color:#c0392b;flex-shrink:0;"><img alt="teléfono" height="20" src="/Clinica/img/emojis/telefono.png" style="vertical-align:middle;" width="20"/> (01) 611-4000</a>
</div>
</div>
</section>
<!-- FOOTER -->
...
`;function yr(){return(0,j.jsx)(tr,{html:vr,scripts:[`/Clinica/js/login.js`,`/Clinica/js/medicos.js`,`/Clinica/js/modal.js`,`/Clinica/js/notificaciones.js`],title:`Nosotros — Clínica José Pardo`})}var br=`
<!-- FRANJA SUPERIOR -->
<div class="franja-contacto d-none d-md-block">
<div class="container-fluid px-4 d-flex justify-content-between align-items-center">
<div class="d-flex gap-4">
...
<ul aria-labelledby="navbarDropdown" class="dropdown-menu">
<li><a class="dropdown-item" href="/Clinica/pages/nosotros.html"><img alt="persona" height="20" src="/Clinica/img/emojis/nosotros.png" style="vertical-align:middle;" width="20"/>‍<img alt="nosotros" height="20" src="/Clinica/img/emojis/nosotros.png" style="vertical-align:middle;" width="20"/> Nosotros</a></li>
<li><a aria-current="page" class="dropdown-item active" href="/Clinica/pages/nuestros-doctores.html"><img alt="doctor" height="20" src="/Clinica/img/emojis/doctor-avatar.png" style="vertical-align:middle;" width="20"/> Nuestros Doctores</a></li>
<li><a class="dropdown-item" href="/Clinica/pages/consejos-de-salud.html"><img alt="idea" height="20" src="/Clinica/img/emojis/idea.png" style="vertical-align:middle;" width="20"/> Consejos de Salud</a></li>
</ul>
</li>
</ul>
...
<div class="hero-slide hero-slide-1 d-flex align-items-center justify-content-center px-4">
<div class="text-center text-white" style="max-width:680px;">
<div class="hero-badge"><img alt="doctor" height="20" src="/Clinica/img/emojis/doctor-avatar.png" style="vertical-align:middle;" width="20"/> NUESTRO EQUIPO MÉDICO</div>
<h1 class="fw-bold mb-3" style="font-size:clamp(1.8rem,4.5vw,3rem); line-height:1.15;">Especialistas que<br/><span style="color:#a8d8f0;">realmente te escuchan</span></h1>
<p class="mb-4 opacity-85" style="font-size:1.05rem;">Conoce a los médicos de la Clínica José Pardo, sus especialidades y horarios.</p>
<div class="d-flex justify-content-center gap-3 flex-wrap">
<button class="hero-cta-btn" onclick="verificarSesionParaCita()"><img alt="calendario" height="20" src="/Clinica/img/emojis/calendario.png" style="vertical-align:middle;" width="20"/> Reservar Cita</button>
<a class="hero-cta-btn-outline" href="/Clinica/pages/index.html">← Volver al Inicio</a>
</div>
...
<div class="hero-slide hero-slide-2 d-flex align-items-center justify-content-center px-4">
<div class="text-center text-white" style="max-width:680px;">
<div class="hero-badge"><img alt="médico" height="20" src="/Clinica/img/emojis/estetoscopio.png" style="vertical-align:middle;" width="20"/> ATENCIÓN ESPECIALIZADA</div>
<h1 class="fw-bold mb-3" style="font-size:clamp(1.8rem,4.5vw,3rem);">8 especialidades,<br/><span style="color:#a8f0e8;">un solo lugar</span></h1>
<p class="mb-4 opacity-85">Cardiología, Neurología, Pediatría, Ginecología, Traumatología y más.</p>
<button class="hero-cta-btn" onclick="verificarSesionParaCita()"><img alt="calendario" height="20" src="/Clinica/img/emojis/calendario.png" style="vertical-align:middle;" width="20"/> Reservar Cita</button>
</div>
</div>
</div>
...
<div class="hero-slide hero-slide-3 d-flex align-items-center justify-content-center px-4">
<div class="text-center text-white" style="max-width:680px;">
<div class="hero-badge"><img alt="calendario" height="20" src="/Clinica/img/emojis/calendario.png" style="vertical-align:middle;" width="20"/> RESERVA TU CITA</div>
<h1 class="fw-bold mb-3" style="font-size:clamp(1.8rem,4.5vw,3rem);">Tu consulta en<br/><span style="color:#a8d8f0;">menos de 2 minutos</span></h1>
<p class="mb-4 opacity-85">Elige especialidad, médico, fecha y hora desde nuestra plataforma digital.</p>
<button class="hero-cta-btn" onclick="verificarSesionParaCita()"><img alt="calendario" height="20" src="/Clinica/img/emojis/calendario.png" style="vertical-align:middle;" width="20"/> Reservar Cita</button>
</div>
</div>
</div>
...
<section class="py-4" style="background:#f8fbff;">
<div class="container">
<div class="text-center mb-4">
<h2 class="fw-bold" style="color:#0A3760;">Nuestro Equipo Médico</h2>
<p class="text-muted">Especialistas con vocación, experiencia y compromiso con tu salud</p>
</div>
<div class="d-flex flex-wrap justify-content-center gap-2 mb-2">
<div class="especialidad-pill"><span><img alt="médico" height="20" src="/Clinica/img/emojis/estetoscopio.png" style="vertical-align:middle;" width="20"/></span> Medicina General</div>
<div class="especialidad-pill"><span><img alt="cardiología" height="20" src="/Clinica/img/emojis/corazon-cardiologia.png" style="vertical-align:middle;" width="20"/></span> Cardiología</div>
<div class="especialidad-pill"><span><img alt="neurología" height="20" src="/Clinica/img/emojis/cerebro.png" style="vertical-align:middle;" width="20"/></span> Neurología</div>
<div class="especialidad-pill"><span><img alt="pediatría" height="20" src="/Clinica/img/emojis/pediatria.png" style="vertical-align:middle;" width="20"/></span> Pediatría</div>
<div class="especialidad-pill"><span><img alt="traumatología" height="20" src="/Clinica/img/emojis/traumatologia.png" style="vertical-align:middle;" width="20"/></span> Traumatología</div>
<div class="especialidad-pill"><span><img alt="ver" height="20" src="/Clinica/img/emojis/ver-contrasena.png" style="vertical-align:middle;" width="20"/>️</span> Oftalmología</div>
<div class="especialidad-pill"><span><img alt="ginecología" height="20" src="/Clinica/img/emojis/ginecologia.png" style="vertical-align:middle;" width="20"/></span> Ginecología</div>
<div class="especialidad-pill"><span><img alt="dermatología" height="20" src="/Clinica/img/emojis/dermatologia.png" style="vertical-align:middle;" width="20"/></span> Dermatología</div>
</div>
</div>
</section>
<!-- CARDS DE MEDICOS -->
...
<div class="medico-avatar"><img alt="doctor" height="20" src="/Clinica/img/emojis/doctor-avatar.png" style="vertical-align:middle;" width="20"/></div>
<div class="card-body p-4">
<h5 class="fw-bold mb-1" style="color:#0A3760;">Méd. Joseph Ortega</h5>
<p class="text-muted small mb-2">CMP 45821 · 12 años de experiencia</p>
<div class="mb-2"><span class="horario-badge"><img alt="médico" height="20" src="/Clinica/img/emojis/estetoscopio.png" style="vertical-align:middle;" width="20"/> Medicina General</span><span class="horario-badge"><img alt="traumatología" height="20" src="/Clinica/img/emojis/traumatologia.png" style="vertical-align:middle;" width="20"/> Traumatología</span></div>
<p class="text-muted small mb-3">Especialista en atención primaria y lesiones musculoesqueléticas. Formación en la UPCH y postgrado en fisiatría y rehabilitación.</p>
<div class="mb-3">
<div class="fw-semibold small mb-1" style="color:#0A3760;"><img alt="calendario" height="20" src="/Clinica/img/emojis/calendario.png" style="vertical-align:middle;" width="20"/> Horarios de atención:</div>
<div><span class="horario-badge">Lunes</span><span class="horario-badge">Miércoles</span><span class="horario-badge">Viernes</span></div>
<div class="text-muted small mt-1">8:00 am - 5:00 pm</div>
</div>
<button class="btn btn-sm w-100 fw-semibold text-white" onclick="verificarSesionParaCita()" style="background:#0E588E;border-radius:20px;"><img alt="calendario" height="20" src="/Clinica/img/emojis/calendario.png" style="vertical-align:middle;" width="20"/> Reservar cita</button>
</div>
</div>
</div>
<div class="col-md-6 col-lg-4">
...
<div class="medico-avatar"><img alt="doctor" height="20" src="/Clinica/img/emojis/doctor-avatar.png" style="vertical-align:middle;" width="20"/></div>
<div class="card-body p-4">
<h5 class="fw-bold mb-1" style="color:#0A3760;">Méd. Eduardo Salas</h5>
<p class="text-muted small mb-2">CMP 38742 · 10 años de experiencia</p>
<div class="mb-2"><span class="horario-badge"><img alt="médico" height="20" src="/Clinica/img/emojis/estetoscopio.png" style="vertical-align:middle;" width="20"/> Medicina General</span><span class="horario-badge"><img alt="ver" height="20" src="/Clinica/img/emojis/ver-contrasena.png" style="vertical-align:middle;" width="20"/>️ Oftalmología</span></div>
<p class="text-muted small mb-3">Experto en diagnóstico visual y atención ambulatoria. Postgrado en oftalmología clínica en la Universidad de Navarra, España.</p>
<div class="mb-3">
<div class="fw-semibold small mb-1" style="color:#0A3760;"><img alt="calendario" height="20" src="/Clinica/img/emojis/calendario.png" style="vertical-align:middle;" width="20"/> Horarios de atención:</div>
<div><span class="horario-badge">Martes</span><span class="horario-badge">Jueves</span><span class="horario-badge">Sábado</span></div>
<div class="text-muted small mt-1">8:00 am - 5:00 pm</div>
</div>
<button class="btn btn-sm w-100 fw-semibold text-white" onclick="verificarSesionParaCita()" style="background:#0E588E;border-radius:20px;"><img alt="calendario" height="20" src="/Clinica/img/emojis/calendario.png" style="vertical-align:middle;" width="20"/> Reservar cita</button>
</div>
...
<div class="medico-avatar"><img alt="doctor" height="20" src="/Clinica/img/emojis/doctor-avatar.png" style="vertical-align:middle;" width="20"/></div>
<div class="card-body p-4">
<h5 class="fw-bold mb-1" style="color:#0A3760;">Méd. Ney Flores</h5>
<p class="text-muted small mb-2">CMP 52103 · 15 años de experiencia</p>
<div class="mb-2"><span class="horario-badge"><img alt="cardiología" height="20" src="/Clinica/img/emojis/corazon-cardiologia.png" style="vertical-align:middle;" width="20"/> Cardiología</span><span class="horario-badge"><img alt="neurología" height="20" src="/Clinica/img/emojis/cerebro.png" style="vertical-align:middle;" width="20"/> Neurología</span></div>
<p class="text-muted small mb-3">Cardiólogo y neurólogo con formación en centros especializados de España y Alemania. Referente en Lima para enfermedades cardiovasculares complejas.</p>
<div class="mb-3">
<div class="fw-semibold small mb-1" style="color:#0A3760;"><img alt="calendario" height="20" src="/Clinica/img/emojis/calendario.png" style="vertical-align:middle;" width="20"/> Horarios de atención:</div>
<div><span class="horario-badge">Lunes</span><span class="horario-badge">Miércoles</span><span class="horario-badge">Viernes</span></div>
<div class="text-muted small mt-1">9:00 am – 5:00 pm</div>
</div>
<button class="btn btn-sm w-100 fw-semibold text-white" onclick="verificarSesionParaCita()" style="background:#0E588E;border-radius:20px;"><img alt="calendario" height="20" src="/Clinica/img/emojis/calendario.png" style="vertical-align:middle;" width="20"/> Reservar cita</button>
</div>
</div>
...
<div class="medico-avatar"><img alt="doctor" height="20" src="/Clinica/img/emojis/doctor-avatar.png" style="vertical-align:middle;" width="20"/></div>
<div class="card-body p-4">
<h5 class="fw-bold mb-1" style="color:#0A3760;">Méd. Enrique Quispe</h5>
<p class="text-muted small mb-2">CMP 41560 · 8 años de experiencia</p>
<div class="mb-2"><span class="horario-badge"><img alt="pediatría" height="20" src="/Clinica/img/emojis/pediatria.png" style="vertical-align:middle;" width="20"/> Pediatría</span><span class="horario-badge"><img alt="dermatología" height="20" src="/Clinica/img/emojis/dermatologia.png" style="vertical-align:middle;" width="20"/> Dermatología</span></div>
<p class="text-muted small mb-3">Médico referente de las familias. Especializado en salud infantil y enfermedades cutáneas pediátricas y del adulto. Trato cercano y empático.</p>
<div class="mb-3">
<div class="fw-semibold small mb-1" style="color:#0A3760;"><img alt="calendario" height="20" src="/Clinica/img/emojis/calendario.png" style="vertical-align:middle;" width="20"/> Horarios de atención:</div>
<div><span class="horario-badge">Martes</span><span class="horario-badge">Jueves</span><span class="horario-badge">Sábado</span></div>
<div class="text-muted small mt-1">8:00 am - 5:00 pm</div>
...
<div class="medico-avatar"><img alt="doctor" height="20" src="/Clinica/img/emojis/doctor-avatar.png" style="vertical-align:middle;" width="20"/></div>
<div class="card-body p-4">
<h5 class="fw-bold mb-1" style="color:#0A3760;">Méd. Aaron Vásquez</h5>
<p class="text-muted small mb-2">CMP 39874 · 11 años de experiencia</p>
<div class="mb-2"><span class="horario-badge"><img alt="ginecología" height="20" src="/Clinica/img/emojis/ginecologia.png" style="vertical-align:middle;" width="20"/> Ginecología</span></div>
<p class="text-muted small mb-3">11 años dedicados a la salud femenina integral: atención prenatal, ginecológica preventiva y tratamiento de patologías del sistema reproductivo.</p>
<div class="mb-3">
<div class="fw-semibold small mb-1" style="color:#0A3760;"><img alt="calendario" height="20" src="/Clinica/img/emojis/calendario.png" style="vertical-align:middle;" width="20"/> Horarios de atención:</div>
<div><span class="horario-badge">Lunes</span><span class="horario-badge">Miércoles</span><span class="horario-badge">Viernes</span></div>
<div class="text-muted small mt-1">8:00 am - 5:00 pm</div>
...
<div class="rounded-4 d-flex flex-column align-items-center justify-content-center text-center p-4 w-100" style="background:linear-gradient(135deg,#0A3760,#0E588E); color:#fff; min-height:350px;">
<div style="font-size:3.5rem;"><img alt="calendario" height="20" src="/Clinica/img/emojis/calendario.png" style="vertical-align:middle;" width="20"/></div>
<h5 class="fw-bold mt-3 mb-2">¿Listo para tu consulta?</h5>
<p class="small opacity-85 mb-4">Reserva tu cita en línea en menos de 2 minutos. Elige especialidad, médico y el horario que más te convenga.</p>
<button class="hero-cta-btn" onclick="verificarSesionParaCita()">Reservar ahora</button>
</div>
</div>
</div>
</div>
...
<div class="col-6 col-md-3"><div style="font-size:2.5rem;font-weight:900;">5</div><div style="opacity:.8;font-size:.9rem;">Especialistas</div></div>
<div class="col-6 col-md-3"><div style="font-size:2.5rem;font-weight:900;">8</div><div style="opacity:.8;font-size:.9rem;">Especialidades</div></div>
<div class="col-6 col-md-3"><div style="font-size:2.5rem;font-weight:900;">56+</div><div style="opacity:.8;font-size:.9rem;">Años combinados</div></div>
<div class="col-6 col-md-3"><div style="font-size:2.5rem;font-weight:900;">24/7</div><div style="opacity:.8;font-size:.9rem;">Emergencias</div></div>
</div>
</div>
</section>
<!-- FOOTER -->
...
`;function xr(){return(0,j.jsx)(tr,{html:br,scripts:[`/Clinica/js/modal.js`,`/Clinica/js/login.js`,`/Clinica/js/medicos.js`,`/Clinica/js/notificaciones.js`],title:`Nuestros Doctores — Clínica José Pardo`})}var Sr=`
...
<!-- ALERTAS -->
<div class="alert alert-danger d-none py-2 small" id="alerta-error" role="alert"></div>
<div class="alert alert-success d-none py-2 small" id="alerta-exito" role="alert"></div>
<span class="badge-role badge-paciente"><img alt="hospital" height="20" src="/Clinica/img/emojis/hospital.png" style="vertical-align:middle;" width="20"/> Nuevo Paciente</span>
<!-- FORMULARIO -->
<div class="row">
<div class="col-6 mb-3">
<label class="form-label">Nombres</label>
<input class="form-control" id="reg-nombres" placeholder="Ej: Juan Carlos" type="text"/>
</div>
<div class="col-6 mb-3">
<label class="form-label">Apellidos</label>
<input class="form-control" id="reg-apellidos" placeholder="Ej: López Pérez" type="text"/>
</div>
</div>
<div class="row">
<div class="col-6 mb-3">
<label class="form-label">DNI</label>
<input class="form-control" id="reg-dni" maxlength="8" placeholder="12345678" type="text"/>
</div>
<div class="col-6 mb-3">
<label class="form-label">Teléfono</label>
<input class="form-control" id="reg-telefono" maxlength="9" placeholder="987654321" type="tel"/>
</div>
</div>
<div class="mb-3">
<label class="form-label">Correo electrónico</label>
<input class="form-control" id="reg-correo" placeholder="ejemplo@gmail.com" type="email"/>
</div>
<div class="row">
<div class="col-6 mb-3">
<label class="form-label">Contraseña</label>
<div class="input-pass">
<input class="form-control" id="reg-password" placeholder="••••••••" type="password"/>
<button class="toggle-pass" onclick="togglePass('reg-password', this)" type="button"><img alt="ver" height="20" src="/Clinica/img/emojis/ver-contrasena.png" style="vertical-align:middle;" width="20"/>️</button>
</div>
</div>
<div class="col-6 mb-3">
<label class="form-label">Confirmar contraseña</label>
<div class="input-pass">
<input class="form-control" id="reg-password2" placeholder="••••••••" type="password"/>
<button class="toggle-pass" onclick="togglePass('reg-password2', this)" type="button"><img alt="ver" height="20" src="/Clinica/img/emojis/ver-contrasena.png" style="vertical-align:middle;" width="20"/>️</button>
</div>
</div>
</div>
<!-- INDICADOR DE FORTALEZA -->
<div class="pass-strength mb-3">
<div class="strength-bar">
<div class="strength-fill" id="strength-fill"></div>
</div>
<span class="strength-label" id="strength-label"></span>
</div>
<button class="btn-register-main" onclick="registrar()">Crear cuenta</button>
<hr class="divider"/>
...
`;function Cr(){return(0,j.jsx)(tr,{html:Sr,scripts:[`/Clinica/js/register.js`],title:`Registro - Clínica José Pardo`})}function wr(){return(0,j.jsx)(Mn,{children:(0,j.jsxs)(Wt,{children:[(0,j.jsx)(A,{path:`/`,element:(0,j.jsx)(dr,{})}),(0,j.jsx)(A,{path:`/Clinica/pages/index.html`,element:(0,j.jsx)(dr,{})}),(0,j.jsx)(A,{path:`/Clinica/pages/login.html`,element:(0,j.jsx)(pr,{})}),(0,j.jsx)(A,{path:`/Clinica/pages/register.html`,element:(0,j.jsx)(Cr,{})}),(0,j.jsx)(A,{path:`/Clinica/pages/mis-citas.html`,element:(0,j.jsx)(_r,{})}),(0,j.jsx)(A,{path:`/Clinica/pages/mi-perfil.html`,element:(0,j.jsx)(hr,{})}),(0,j.jsx)(A,{path:`/Clinica/pages/nosotros.html`,element:(0,j.jsx)(yr,{})}),(0,j.jsx)(A,{path:`/Clinica/pages/nuestros-doctores.html`,element:(0,j.jsx)(xr,{})}),(0,j.jsx)(A,{path:`/Clinica/pages/consejos-de-salud.html`,element:(0,j.jsx)(sr,{})}),(0,j.jsx)(A,{path:`/Clinica/pages/doctor.html`,element:(0,j.jsx)(lr,{})}),(0,j.jsx)(A,{path:`/Clinica/pages/admin.html`,element:(0,j.jsx)(ar,{})}),(0,j.jsx)(A,{path:`/Clinica/pages/admin-login.html`,element:(0,j.jsx)(rr,{})}),(0,j.jsx)(A,{path:`/index`,element:(0,j.jsx)(dr,{})}),(0,j.jsx)(A,{path:`/login`,element:(0,j.jsx)(pr,{})}),(0,j.jsx)(A,{path:`/register`,element:(0,j.jsx)(Cr,{})}),(0,j.jsx)(A,{path:`/mis-citas`,element:(0,j.jsx)(_r,{})}),(0,j.jsx)(A,{path:`/mi-perfil`,element:(0,j.jsx)(hr,{})}),(0,j.jsx)(A,{path:`/nosotros`,element:(0,j.jsx)(yr,{})}),(0,j.jsx)(A,{path:`/nuestros-doctores`,element:(0,j.jsx)(xr,{})}),(0,j.jsx)(A,{path:`/consejos-de-salud`,element:(0,j.jsx)(sr,{})}),(0,j.jsx)(A,{path:`/doctor`,element:(0,j.jsx)(lr,{})}),(0,j.jsx)(A,{path:`/admin`,element:(0,j.jsx)(ar,{})}),(0,j.jsx)(A,{path:`/admin-login`,element:(0,j.jsx)(rr,{})}),(0,j.jsx)(A,{path:`*`,element:(0,j.jsx)(Ht,{to:`/`,replace:!0})})]})})}(0,er.createRoot)(document.getElementById(`root`)).render((0,j.jsx)(x.StrictMode,{children:(0,j.jsx)(wr,{})}));